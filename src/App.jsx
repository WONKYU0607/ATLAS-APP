...
// ── 인천 ──
"인천":{
en:{description:"Incheon is Korea's gateway city with Chinatown, Songdo International City, and beautiful islands forming an attractive port city. The history of the port opening and modern urban development coexist.",spots:{"차이나타운":{name:"Incheon Chinatown",desc:"Korea's only official Chinatown with a 140-year history. Jajangmyeon noodles and various Chinese street foods are famous."},"송도국제도시":{name:"Songdo International City",desc:"A futuristic smart city built on reclaimed land. Central Park's sea water canal and modern architecture are impressive."},"월미도":{name:"Wolmido Island",desc:"An island amusement park and cultural space connected to downtown Incheon. The Viking ride and seafood street are popular."},"을왕리 해변":{name:"Eulwangri Beach",desc:"A beautiful beach on Yeongjong Island near Incheon Airport. The sunset while watching planes land is unique."},"인천 개항장 거리":{name:"Incheon Open Port Street",desc:"A street preserving modern architecture from when the port opened in 1883. Jemulpo Gurakbu and Jayu Park are must-sees."}}},
ja:{description:"仁川は大韓民国の玄関都市で、チャイナタウン、松島国際都市、美しい島々が調和した魅力的な港町です。開港の歴史と現代的な都市開発が共存しています。",spots:{"차이나타운":{name:"仁川チャイナタウン",desc:"140年の歴史を持つ韓国唯一の公式チャイナタウンです。ジャージャー麺と各種中華街グルメが有名です。"},"송도국제도시":{name:"松島国際都市",desc:"埋立地に建設された未来型スマートシティです。セントラルパークの海水運河と現代建築が印象的です。"},"월미도":{name:"月尾島",desc:"仁川市内と繋がった島の遊園地と文化空間です。バイキングと海産物通りが人気です。"},"을왕리 해변":{name:"乙旺里海水浴場",desc:"仁川空港近くの永宗島にある美しい海水浴場です。飛行機の着陸を見ながらの夕暮れが独特です。"},"인천 개항장 거리":{name:"仁川開港場通り",desc:"1883年の開港当時の近代建築が保存された通りです。済物浦倶楽部と自由公園は必見です。"}}},
zh:{description:"仁川是韩国的门户城市，唐人街、松岛国际城和美丽的岛屿构成了迷人的港口城市。开埠历史与现代城市发展并存。",spots:{"차이나타운":{name:"仁川唐人街",desc:"拥有140年历史的韩国唯一官方唐人街。炸酱面和各种中式街头美食闻名。"},"송도국제도시":{name:"松岛国际城",desc:"在填海地上建造的未来型智慧城市。中央公园的海水运河和现代建筑令人印象深刻。"},"월미도":{name:"月尾岛",desc:"与仁川市区相连的岛屿游乐园和文化空间。海盗船和海鲜街很受欢迎。"},"을왕리 해변":{name:"乙旺里海滩",desc:"仁川机场附近永宗岛上的美丽海滩。看着飞机降落的日落别有韵味。"},"인천 개항장 거리":{name:"仁川开埠街",desc:"保存着1883年开埠时近代建筑的街道。济物浦俱乐部和自由公园是必看景点。"}}}
},

// ── 대구 ──
"대구":{
en:{description:"Daegu is a hot basin city famous for its vibrant Yangnyeongsi herbal medicine market history, modern culture alleys, and delicious food. The surrounding natural scenery including Palgongsan and Apsan mountains is also excellent.",spots:{"김광석 다시그리기 길":{name:"Kim Kwang-seok Street",desc:"A mural street commemorating the late folk singer Kim Kwang-seok. The walls are filled with his song lyrics and stories."},"서문시장":{name:"Seomun Market",desc:"One of Korea's three major traditional markets opened in 1669. The night market with tteokbokki and various street foods is famous."},"팔공산":{name:"Palgongsan Mountain",desc:"A famous mountain in Daegu with Donghwasa Temple and the massive Gatbawi Buddha statue. Especially beautiful in autumn foliage season."},"83타워":{name:"83 Tower",desc:"A 202m tall observation tower offering a panoramic view of Daegu city. Particularly beautiful at night."},"대구 근대골목":{name:"Daegu Modern History Alleys",desc:"Alleys preserving modern era architecture and history. You can trace Daegu's modern history through various themed courses."}}},
ja:{description:"大邱は盆地地形の暑い都市で、華やかな薬令市の歴史、近代文化路地、美味しい料理で有名です。八公山や앞山など周辺の自然景観も優れています。",spots:{"김광석 다시그리기 길":{name:"キム・グァンソク通り",desc:"故フォーク歌手キム・グァンソクを偲ぶ壁画通りです。壁には彼の歌詞とストーリーが描かれています。"},"서문시장":{name:"西門市場",desc:"1669年に開場した韓国三大伝統市場の一つです。トッポッキや各種屋台グルメの夜市が有名です。"},"팔공산":{name:"八公山",desc:"桐華寺と巨大なガッバウィ仏像がある大邱の名山です。特に紅葉の季節が美しいです。"},"83타워":{name:"83タワー",desc:"高さ202mの展望塔で大邱市内を一望できます。夜景が特に美しいです。"},"대구 근대골목":{name:"大邱近代路地",desc:"近代建築と歴史が保存された路地です。様々なテーマコースで大邱の近代史を辿れます。"}}},
zh:{description:"大邱是盆地地形的炎热城市，以繁华的药令市历史、近代文化胡同和美食闻名。八公山和前山等周边自然景观也很出色。",spots:{"김광석 다시그리기 길":{name:"金光石壁画街",desc:"纪念已故民谣歌手金光石的壁画街。墙上画满了他的歌词和故事。"},"서문시장":{name:"西门市场",desc:"1669年开业的韩国三大传统市场之一。炒年糕和各种街头美食的夜市很有名。"},"팔공산":{name:"八公山",desc:"有桐华寺和巨大磨崖佛像的大邱名山。秋季枫叶尤为美丽。"},"83타워":{name:"83塔",desc:"高202米的观景塔，可俯瞰大邱全景。夜景特别美。"},"대구 근대골목":{name:"大邱近代胡同",desc:"保存着近代建筑和历史的胡同。可通过各种主题路线追溯大邱近代史。"}}}
},

// ── 전주 ──
"전주":{
en:{description:"Jeonju is a city of Korean taste and culture, world-famous for Jeonju Hanok Village and bibimbap. Designated as a UNESCO City of Gastronomy, it's a culinary capital.",spots:{"전주한옥마을":{name:"Jeonju Hanok Village",desc:"Korea's largest traditional hanok village with over 800 hanoks. The scenery in hanbok is especially beautiful."},"전주 비빔밥":{name:"Jeonju Bibimbap",desc:"The origin of Korean bibimbap, mixing various vegetables and meat with Jeonju's special red pepper paste. A UNESCO Creative City dish."},"경기전":{name:"Gyeonggijeon Shrine",desc:"A Joseon Dynasty shrine enshrining a portrait of King Taejo. The beautiful dancheong (traditional multicolored paintwork) is impressive."},"전동성당":{name:"Jeondong Cathedral",desc:"A beautiful Romanesque cathedral built in 1914. A filming location for many movies and dramas."},"남부시장 야시장":{name:"Nambu Market Night Market",desc:"A vibrant night market with diverse street foods. Especially famous for choco pies and bindaetteok."}}},
ja:{description:"全州は韓国の味と趣の都市で、全州韓屋村とビビンバで世界的に有名です。ユネスコ食の創意都市に選ばれた美食の都です。",spots:{"전주한옥마을":{name:"全州韓屋村",desc:"800軒以上の韓屋がある韓国最大の伝統韓屋村です。韓服姿の風景が特に美しいです。"},"전주 비빔밥":{name:"全州ビビンバ",desc:"韓国ビビンバの元祖で、各種野菜と肉を全州特製コチュジャンで混ぜます。ユネスコ創意都市料理です。"},"경기전":{name:"慶基殿",desc:"朝鮮太祖の御真を奉安した朝鮮時代の祠堂です。美しい丹青が印象的です。"},"전동성당":{name:"殿洞聖堂",desc:"1914年に建てられた美しいロマネスク様式の聖堂です。多くの映画やドラマのロケ地です。"},"남부시장 야시장":{name:"南部市場夜市",desc:"多様な屋台グルメで賑わう夜市です。特にチョコパイとビンデトクが有名です。"}}},
zh:{description:"全州是韩国的美味与韵味之城，以全州韩屋村和拌饭享誉世界。被评为联合国教科文组织美食创意城市。",spots:{"전주한옥마을":{name:"全州韩屋村",desc:"拥有800多栋韩屋的韩国最大传统韩屋村。穿韩服的景色格外美丽。"},"전주 비빔밥":{name:"全州拌饭",desc:"韩国拌饭的起源，用全州特制辣椒酱拌各种蔬菜和肉。联合国教科文组织创意城市美食。"},"경기전":{name:"庆基殿",desc:"供奉朝鲜太祖御真的朝鲜时代祠堂。美丽的丹青令人印象深刻。"},"전동성당":{name:"殿洞圣堂",desc:"1914年建造的美丽罗马式圣堂。是许多电影和电视剧的拍摄地。"},"남부시장 야시장":{name:"南部市场夜市",desc:"各种街头美食热闹非凡的夜市。巧克力派和绿豆煎饼尤为有名。"}}}
},

// ── 강릉 ──
"강릉":{
en:{description:"Gangneung is a jewel of the East Coast, famous for beautiful beaches, coffee culture, and the heritage of Shin Saimdang and Yulgok. It was also a host city for the 2018 PyeongChang Winter Olympics.",spots:{"경포대 해변":{name:"Gyeongpo Beach",desc:"One of Korea's top beaches with a 6km white sandy shore. The sunrise is spectacular, and the lakeside pavilion adds to the charm."},"정동진":{name:"Jeongdongjin",desc:"Famous for the closest train station to the sea and sunrise viewing. The hourglass park and rail bike are popular."},"오죽헌":{name:"Ojukheon House",desc:"Birthplace of Shin Saimdang and her son Yulgok Yi I, a Joseon scholar. Black bamboo groves surround the traditional house."},"강릉 커피거리":{name:"Gangneung Coffee Street",desc:"Korea's coffee capital with numerous specialty coffee shops. Anmok Beach coffee street is especially famous."},"선교장":{name:"Seongyojang House",desc:"A well-preserved noble family house from the Joseon Dynasty. The lotus pond and pavilion create a picturesque scene."}}},
ja:{description:"江陵は東海岸の宝石のような都市で、美しい海辺とコーヒー文化、申師任堂と栗谷の遺跡で有名です。2018平昌冬季五輪の主要競技が開かれた都市でもあります。",spots:{"경포대 해변":{name:"鏡浦台ビーチ",desc:"6kmの白い砂浜が広がる韓国最高のビーチの一つです。日の出が壮観で、湖畔の亭子も魅力的です。"},"정동진":{name:"正東津",desc:"海に最も近い駅と日の出観覧で有名です。砂時計公園とレールバイクが人気です。"},"오죽헌":{name:"烏竹軒",desc:"申師任堂とその息子栗谷李珥の生家で、朝鮮時代の学者の家です。黒竹林が家を囲んでいます。"},"강릉 커피거리":{name:"江陵コーヒー通り",desc:"韓国のコーヒーの首都で数多くの専門コーヒーショップがあります。安木ビーチのコーヒー通りが特に有名です。"},"선교장":{name:"船橋荘",desc:"朝鮮時代の両班家屋がよく保存されています。蓮池と亭子が絵のような風景を作ります。"}}},
zh:{description:"江陵是东海岸的宝石之城，以美丽的海滩、咖啡文化和申师任堂、栗谷的遗迹而闻名。也是2018平昌冬奥会的主要比赛举办城市。",spots:{"경포대 해변":{name:"镜浦台海滩",desc:"拥有6公里白沙滩的韩国顶级海滩之一。日出壮观，湖畔亭台更添魅力。"},"정동진":{name:"正东津",desc:"以最靠近大海的火车站和日出观赏而闻名。沙漏公园和铁路自行车很受欢迎。"},"오죽헌":{name:"乌竹轩",desc:"申师任堂及其子栗谷李珥的诞生地，是朝鲜时代学者故居。黑竹林环绕传统房屋。"},"강릉 커피거리":{name:"江陵咖啡街",desc:"韩国的咖啡之都，拥有众多精品咖啡店。安木海滩咖啡街尤为著名。"},"선교장":{name:"船桥庄",desc:"保存完好的朝鲜时代士大夫宅邸。荷花池与亭台构成如画美景。"}}}
},

// ── 수원 ──
"수원":{
en:{description:"Suwon is a historical-technological city where King Jeongjo's filial piety-inspired Hwaseong Fortress coexists with cutting-edge Samsung campuses. UNESCO World Heritage Suwon Hwaseong is the pinnacle of Korean fortress architecture.",spots:{"수원 화성":{name:"Suwon Hwaseong Fortress",desc:"A UNESCO World Heritage fortress built in 1796 combining Eastern and Western military technologies. Walking the 5.7km fortress wall offers great city views."},"행궁":{name:"Hwaseong Haenggung Palace",desc:"King Jeongjo's temporary palace with the largest scale among Joseon era haenggung. Traditional martial arts performances are regularly held."},"화성행궁 야간 개장":{name:"Hwaseong Night Tour",desc:"The fortress is beautifully illuminated at night. The nighttime fortress walk offers a different charm."},"수원 갈비":{name:"Suwon Galbi",desc:"Suwon's representative dish of grilled marinated beef ribs. The meat is tender and the seasoning is excellent."},"융건릉":{name:"Yungneung and Geolleung Royal Tombs",desc:"Royal tombs of King Jeongjo and his parents. The beautiful forest path is perfect for a walk."}}},
ja:{description:"水原は正祖大王の孝心が込められた華城と最先端のサムスンキャンパスが共存する歴史・技術都市です。ユネスコ世界文化遺産の水原華城は韓国城郭建築の白眉です。",spots:{"수원 화성":{name:"水原華城",desc:"1796年に東西軍事技術を融合して建てられたユネスコ世界文化遺産の城郭です。5.7kmの城壁を歩けば市内の眺めが素晴らしいです。"},"행궁":{name:"華城行宮",desc:"正祖の離宮で朝鮮時代の行宮の中で最大規模です。伝統武芸公演が定期的に開かれます。"},"화성행궁 야간 개장":{name:"華城夜間観覧",desc:"夜には城郭が美しく照明されます。夜の城郭散策は昼とは違った魅力があります。"},"수원 갈비":{name:"水原カルビ",desc:"水原を代表する味付けカルビ焼肉です。肉が柔らかく味付けが絶品です。"},"융건릉":{name:"隆健陵",desc:"正祖と両親の王陵です。美しい森の道が散策に最適です。"}}},
zh:{description:"水原是正祖大王孝心凝聚的华城与尖端三星园区并存的历史·科技之城。联合国教科文组织世界文化遗产水原华城是韩国城郭建筑的巅峰之作。",spots:{"수원 화성":{name:"水原华城",desc:"1796年融合东西方军事技术建造的联合国教科文组织世界文化遗产城郭。漫步5.7公里城墙可欣赏城市美景。"},"행궁":{name:"华城行宫",desc:"正祖的临时宫殿，是朝鲜时代行宫中规模最大的。定期举办传统武艺表演。"},"화성행궁 야간 개장":{name:"华城夜间开放",desc:"夜晚城郭灯火辉煌。夜游城郭别有一番风味。"},"수원 갈비":{name:"水原排骨",desc:"水原代表美食腌制烤牛排骨。肉质鲜嫩，调味绝佳。"},"융건릉":{name:"隆健陵",desc:"正祖及其父母的王陵。美丽的林间小道适合散步。"}}}
},

// ── 광주 ──
"광주":{
en:{description:"Gwangju is both a sacred site of Korean democracy and a city of arts and culture. The Gwangju Biennale, Mudeungsan Mountain, and rich culinary culture captivate travelers.",spots:{"국립아시아문화전당":{name:"Asia Culture Center",desc:"A massive cultural complex showcasing Asian culture and arts. The futuristic architecture is impressive."},"양림동 펭귄마을":{name:"Yangnim-dong Penguin Village",desc:"A neighborhood with well-preserved modern-era buildings. Murals and cafes create a charming atmosphere."},"5·18 민주광장":{name:"May 18th Democracy Square",desc:"A historic site commemorating the Gwangju Democratization Movement. The national cemetery is solemn."},"무등산":{name:"Mudeungsan Mountain",desc:"Gwangju's symbolic mountain and a national park. The Seoseokdae rock formations are spectacular."},"광주 비빔밥":{name:"Gwangju Bibimbap",desc:"Along with Jeonju, Gwangju is famous for bibimbap. The generous portions and variety of ingredients are characteristics."}}},
ja:{description:"光州は大韓民国民主主義の聖地であり、芸術と文化の都市です。光州ビエンナーレと無等山、豊かな美食文化が旅行者を魅了します。",spots:{"국립아시아문화전당":{name:"国立アジア文化殿堂",desc:"アジアの文化芸術を披露する巨大文化複合施設です。未来的な建築が印象的です。"},"양림동 펭귄마을":{name:"楊林洞ペンギン村",desc:"近代建築がよく保存された街です。壁画とカフェが魅力的な雰囲気を作ります。"},"5·18 민주광장":{name:"5·18民主広場",desc:"光州民主化運動を記念する歴史的な場所です。国立墓地は厳粛です。"},"무등산":{name:"無等山",desc:"光州の象徴的な山で国立公園です。瑞石台の岩石群が壮観です。"},"광주 비빔밥":{name:"光州ビビンバ",desc:"全州と共に光州もビビンバで有名です。たっぷりの量と多様な材料が特徴です。"}}},
zh:{description:"光州是韩国民主主义的圣地，也是艺术与文化之城。光州双年展、无等山和丰富的美食文化吸引着游客。",spots:{"국립아시아문화전당":{name:"国立亚洲文化殿堂",desc:"展示亚洲文化艺术的大型文化综合设施。未来感十足的建筑令人印象深刻。"},"양림동 펭귄마을":{name:"杨林洞企鹅村",desc:"保存完好的近代建筑街区。壁画和咖啡馆营造出迷人氛围。"},"5·18 민주광장":{name:"5·18民主广场",desc:"纪念光州民主化运动的历史场所。国立墓地庄严肃穆。"},"무등산":{name:"无等山",desc:"光州的象征性山峰，国家公园。瑞石台岩石群壮观。"},"광주 비빔밥":{name:"光州拌饭",desc:"与全州一样，光州也以拌饭闻名。分量充足、食材丰富是其特色。"}}}
},

// ── 여수 ──
"여수":{
en:{description:"Yeosu is a beautiful port city of the southern coast with stunning maritime scenery. The cable car night view and Hyangiram Hermitage are must-sees.",spots:{"여수 케이블카":{name:"Yeosu Cable Car",desc:"Korea's first marine cable car connecting the city to Dolsan Island. The night view of the illuminated Dolsan Bridge is magnificent."},"향일암":{name:"Hyangiram Hermitage",desc:"A cliffside hermitage facing the sunrise. Built in 644 AD, it's one of Korea's four major sunrise viewing spots."},"오동도":{name:"Odongdo Island",desc:"An island connected to the mainland by a breakwater, famous for its camellia forest. The 768m camellia tunnel is beautiful."},"여수 밤바다":{name:"Yeosu Night Sea",desc:"The romantic night seascape immortalized in the song 'Yeosu Night Sea.' The marine park fountain show is spectacular."},"돌산공원":{name:"Dolsan Park",desc:"A park offering a panoramic view of Yeosu city and the sea. Especially beautiful at sunset and sunrise."}}},
ja:{description:"麗水は南海岸の美しい港町で壮観な海洋景観が魅力です。ケーブルカーの夜景と向日庵は必見です。",spots:{"여수 케이블카":{name:"麗水ケーブルカー",desc:"市街地と突山島を結ぶ韓国初の海上ケーブルカーです。ライトアップされた突山大橋の夜景が壮観です。"},"향일암":{name:"向日庵",desc:"日の出を迎える断崖の庵子です。644年に建立された韓国4大日の出名所の一つです。"},"오동도":{name:"梧桐島",desc:"防波堤で本土と繋がった島で椿の森で有名です。768mの椿トンネルが美しいです。"},"여수 밤바다":{name:"麗水夜の海",desc:"歌「麗水夜の海」でロマンチックに描かれた夜の海の風景です。海洋公園の噴水ショーが壮観です。"},"돌산공원":{name:"突山公園",desc:"麗水市と海を一望できる公園です。夕暮れと日の出の時が特に美しいです。"}}},
zh:{description:"丽水是南海岸的美丽港口城市，拥有壮观的海洋景观。缆车夜景和向日庵是必看景点。",spots:{"여수 케이블카":{name:"丽水缆车",desc:"连接市区与突山岛的韩国首条海上缆车。灯火通明的突山大桥夜景壮丽。"},"향일암":{name:"向日庵",desc:"面向日出的悬崖庵堂。建于公元644年，是韩国四大日出名所之一。"},"오동도":{name:"梧桐岛",desc:"通过防波堤与大陆相连的岛屿，以山茶林闻名。768米的山茶隧道美不胜收。"},"여수 밤바다":{name:"丽水夜海",desc:"歌曲《丽水夜海》中浪漫描绘的夜间海景。海洋公园喷泉秀壮观。"},"돌산공원":{name:"突山公园",desc:"可俯瞰丽水市区和大海的公园。日落和日出时分尤为美丽。"}}}
},

// ── 속초 ──
"속초":{
en:{description:"Sokcho is a gateway to Seoraksan National Park and a city where beautiful East Sea beaches meet delicious seafood. The Abai Village and Jungang Market are filled with unique local charm.",spots:{"설악산":{name:"Seoraksan Mountain",desc:"Korea's most beautiful mountain and a UNESCO Biosphere Reserve. Cable car rides to Gwongeumseong Fortress are popular."},"속초 해변":{name:"Sokcho Beach",desc:"A clean beach in the city center. The view of fishing boats returning at sunrise is picturesque."},"아바이마을":{name:"Abai Village",desc:"A North Korean refugee village with a unique ferry crossing. Abai sundae (blood sausage) is famous."},"설악 케이블카":{name:"Seorak Cable Car",desc:"An aerial tramway to Gwongeumseong Fortress 800m up Seoraksan. The panoramic mountain view is spectacular."},"속초 중앙시장":{name:"Sokcho Jungang Market",desc:"A traditional market with fresh seafood and street food. Dakgangjeong (sweet crispy chicken) is a must-try."}}},
ja:{description:"束草は雪岳山国立公園への玄関口であり、美しい東海のビーチと美味しい海産物が出会う都市です。アバイ村と中央市場には独特の地域の魅力があふれています。",spots:{"설악산":{name:"雪岳山",desc:"韓国で最も美しい山でユネスコ生物圏保護区です。権金城へのケーブルカーが人気です。"},"속초 해변":{name:"束草ビーチ",desc:"市内中心部にある清潔なビーチです。日の出に漁船が帰港する風景が絵のようです。"},"아바이마을":{name:"アバイ村",desc:"北朝鮮避難民の村で独特な渡し船があります。アバイスンデが有名です。"},"설악 케이블카":{name:"雪岳ケーブルカー",desc:"雪岳山800m上の権金城へ登る空中ケーブルカーです。山のパノラマビューが壮観です。"},"속초 중앙시장":{name:"束草中央市場",desc:"新鮮な海産物と屋台グルメがある伝統市場です。タッカンジョンは必食です。"}}},
zh:{description:"束草是雪岳山国立公园的门户，是美丽的东海海滩与美味海鲜相遇的城市。阿爸村和中央市场充满独特的地方魅力。",spots:{"설악산":{name:"雪岳山",desc:"韩国最美的山，联合国教科文组织生物圈保护区。前往权金城的缆车很受欢迎。"},"속초 해변":{name:"束草海滩",desc:"市中心的干净海滩。日出时渔船归港的景象如画。"},"아바이마을":{name:"阿爸村",desc:"朝鲜难民村，有独特的渡轮。阿爸血肠很有名。"},"설악 케이블카":{name:"雪岳缆车",desc:"通往雪岳山800米高处权金城的空中缆车。山景全景壮观。"},"속초 중앙시장":{name:"束草中央市场",desc:"有新鲜海鲜和街头美食的传统市场。炸鸡块是必吃美食。"}}}
},

// ── 통영 ──
"통영":{
en:{description:"Tongyeong is a picturesque port city known as the music city where composer Yun Isang was born. Cable car views and fresh seafood are highlights.",spots:{"통영 케이블카":{name:"Tongyeong Cable Car",desc:"Korea's first cable car connecting Mireuksan Mountain. The view of islands scattered in Hallyeohaesang is breathtaking."},"동피랑 벽화마을":{name:"Dongpirang Mural Village",desc:"A hillside village saved from redevelopment by colorful murals. Every alley is a photo spot."},"한려수도":{name:"Hallyeohaesang Waterway",desc:"A beautiful waterway with 1,700 islands. Island hopping tours are popular."},"충렬사":{name:"Chungnyeolsa Shrine",desc:"A shrine honoring Admiral Yi Sun-sin. The view of Tongyeong Port from the shrine is excellent."},"통영 꿀빵":{name:"Tongyeong Honey Bread",desc:"Tongyeong's famous street food filled with sweet red bean paste and honey. Best eaten fresh and hot."}}},
ja:{description:"統営は作曲家ユン・イサンの生まれた音楽の都市として知られる絵のような港町です。ケーブルカーからの眺めと新鮮な海産物がハイライトです。",spots:{"통영 케이블카":{name:"統営ケーブルカー",desc:"弥勒山を結ぶ韓国初のケーブルカーです。閑麗海上に散らばる島々の眺めが素晴らしいです。"},"동피랑 벽화마을":{name:"東皮郎壁画村",desc:"色とりどりの壁画で再開発を免れた丘の村です。路地の隅々がフォトスポットです。"},"한려수도":{name:"閑麗水道",desc:"1,700の島がある美しい水路です。アイランドホッピングツアーが人気です。"},"충렬사":{name:"忠烈祠",desc:"李舜臣将軍を祀る祠堂です。祠から統営港の眺めが素晴らしいです。"},"통영 꿀빵":{name:"統営ハチミツパン",desc:"甘い小豆餡とハチミツが入った統営の有名な屋台グルメです。熱々が一番美味しいです。"}}},
zh:{description:"统营是作曲家尹伊桑诞生的音乐之城，也是风景如画的港口城市。缆车美景和新鲜海鲜是亮点。",spots:{"통영 케이블카":{name:"统营缆车",desc:"连接弥勒山的韩国首条缆车。闲丽海上散落岛屿的景色令人叹为观止。"},"동피랑 벽화마을":{name:"东皮郎壁画村",desc:"因五彩壁画而免于拆迁的山坡村庄。每条小巷都是拍照点。"},"한려수도":{name:"闲丽水道",desc:"拥有1700个岛屿的美丽水道。跳岛游很受欢迎。"},"충렬사":{name:"忠烈祠",desc:"供奉李舜臣将军的祠堂。从祠堂可欣赏统营港美景。"},"통영 꿀빵":{name:"统营蜂蜜面包",desc:"内馅甜红豆沙和蜂蜜的统营著名街头小吃。趁热吃最好。"}}}
},
...
// ── 나라 ──
"나라":{
en:{description:"Nara was Japan's first permanent capital from 710-784, famous for its giant Buddha and freely roaming deer. It's an ancient capital dense with World Heritage temples and shrines.",spots:{"도다이지(동대사)":{name:"Todai-ji Temple",desc:"Home to the world's largest bronze Buddha statue at 15m tall. The massive wooden hall is an architectural marvel."},"나라 사슴공원":{name:"Nara Deer Park",desc:"Over 1,200 wild deer roam freely, bowing for senbei crackers. Deer are considered sacred messengers of the gods."},"가스가타이샤":{name:"Kasuga Taisha Shrine",desc:"A UNESCO World Heritage shrine famous for 3,000 stone and bronze lanterns lining the approach."},"고후쿠지":{name:"Kofuku-ji Temple",desc:"A UNESCO World Heritage temple with a five-story pagoda, Nara's symbol visible from across the city."},"나라마치":{name:"Naramachi",desc:"A preserved merchant district with traditional machiya townhouses converted into cafes and craft shops."}}},
ja:{description:"奈良は710〜784年の日本初の本格的な首都で、巨大な大仏と自由に歩き回る鹿で有名です。世界文化遺産の寺社が密集する古都です。",spots:{"도다이지(동대사)":{name:"東大寺",desc:"高さ15mの世界最大の青銅大仏があります。巨大な木造建築は建築の驚異です。"},"나라 사슴공원":{name:"奈良公園の鹿",desc:"1,200頭以上の野生の鹿が自由に歩き回り、せんべいのためにお辞儀をします。鹿は神の使いとされています。"},"가스가타이샤":{name:"春日大社",desc:"参道に並ぶ3,000基の石灯籠と釣灯籠で有名なユネスコ世界文化遺産の神社です。"},"고후쿠지":{name:"興福寺",desc:"五重塔がある世界文化遺産の寺院で、塔は市内各所から見える奈良のシンボルです。"},"나라마치":{name:"ならまち",desc:"伝統的な町家がカフェや工芸品店に改装された保存された商人街です。"}}},
zh:{description:"奈良是公元710-784年日本第一个正式首都，以巨大的佛像和自由漫步的鹿而闻名。是世界文化遗产寺庙神社密集的古都。",spots:{"도다이지(동대사)":{name:"东大寺",desc:"拥有高15米的世界最大青铜佛像。巨大的木造建筑堪称建筑奇迹。"},"나라 사슴공원":{name:"奈良鹿公园",desc:"1200多头野生鹿自由漫步，为仙贝饼干鞠躬。鹿被视为神的使者。"},"가스가타이샤":{name:"春日大社",desc:"参道两旁排列着3000座石灯笼和铜灯笼的联合国教科文组织世界文化遗产神社。"},"고후쿠지":{name:"兴福寺",desc:"拥有五重塔的联合国教科文组织世界文化遗产寺庙，塔是从全城各处都能看到的奈良象征。"},"나라마치":{name:"奈良町",desc:"传统町屋改造成咖啡馆和工艺品店的保存完好的商人街区。"}}}
},

// ── 나고야 ──
"나고야":{
en:{description:"Nagoya is the industrial capital of central Japan, headquarters of Toyota and famous for its unique 'Nagoya-meshi' cuisine. It's also a center of Warring States period history.",spots:{"나고야성":{name:"Nagoya Castle",desc:"A symbol of Nagoya with golden shachihoko (mythical fish) on the roof. The castle was built by Tokugawa Ieyasu."},"도요타 산업기술기념관":{name:"Toyota Commemorative Museum",desc:"A museum showcasing Toyota's evolution from textile machinery to automobiles. Interactive exhibits are engaging."},"오스 상점가":{name:"Osu Shopping District",desc:"A covered shopping arcade with 1,200 shops selling everything from electronics to vintage clothing."},"아츠타 신궁":{name:"Atsuta Shrine",desc:"One of Japan's most important Shinto shrines, said to house the sacred sword Kusanagi."},"히츠마부시(장어덮밥)":{name:"Hitsumabushi",desc:"Nagoya's signature dish of grilled eel enjoyed three ways. Atsuta Horaiken is the famous original restaurant."}}},
ja:{description:"名古屋は日本中部の産業首都で、トヨタの本拠地であり独自の「名古屋めし」文化で有名です。戦国時代の歴史の中心地でもあります。",spots:{"나고야성":{name:"名古屋城",desc:"屋根の金のしゃちほこが名古屋のシンボルです。徳川家康が築城しました。"},"도요타 산업기술기념관":{name:"トヨタ産業技術記念館",desc:"繊維機械から自動車へのトヨタの進化を展示する博物館です。体験展示が魅力的です。"},"오스 상점가":{name:"大須商店街",desc:"電化製品からビンテージ衣料まで1,200店舗が並ぶアーケード商店街です。"},"아츠타 신궁":{name:"熱田神宮",desc:"草薙剣を祀るとされる日本で最も重要な神社の一つです。"},"히츠마부시(장어덮밥)":{name:"ひつまぶし",desc:"名古屋の代表料理で鰻を三つの方法で楽しむ独特なメニューです。熱田蓬莱軒が元祖の名店です。"}}},
zh:{description:"名古屋是日本中部的工业之都，丰田总部所在地，以独特的'名古屋美食'文化闻名。也是战国时代历史的中心。",spots:{"나고야성":{name:"名古屋城",desc:"屋顶金鲸是名古屋的象征。由德川家康修建。"},"도요타 산업기술기념관":{name:"丰田产业技术纪念馆",desc:"展示丰田从纺织机械到汽车演变的博物馆。互动展品引人入胜。"},"오스 상점가":{name:"大须商店街",desc:"拥有1200家店铺的有顶商店街，从电子产品到复古服装应有尽有。"},"아츠타 신궁":{name:"热田神宫",desc:"据说供奉着神剑草薙剑的日本最重要神社之一。"},"히츠마부시(장어덮밥)":{name:"鳗鱼三吃",desc:"名古屋代表美食，用三种方式享用烤鳗鱼的独特菜肴。热田蓬莱轩是著名的元祖店。"}}}
},

// ── 후쿠오카 ──
"후쿠오카":{
en:{description:"Fukuoka is Kyushu's largest city, a mecca for food lovers with tonkotsu ramen and yatai (street food stalls) culture. It's the closest major Japanese city to Korea with excellent accessibility.",spots:{"나카스 야타이":{name:"Nakasu Yatai",desc:"Street food stalls lining the Hakata River showcasing Fukuoka's unique culture. Enjoy tonkotsu ramen, yakitori, and oden while mingling with locals."},"다자이후 텐만구":{name:"Dazaifu Tenman-gū",desc:"A shrine dedicated to Sugawara no Michizane, the god of learning, with annual visits by students. Umegae mochi (plum cakes) along the approach are famous."},"캐널시티 하카타":{name:"Canal City Hakata",desc:"A massive shopping and entertainment complex with an impressive central canal and fountain shows. The Ramen Stadium offers ramen from across Japan."},"오호리 공원":{name:"Ohori Park",desc:"A beautiful lake park in central Fukuoka with a Japanese garden and art museum. The 2km jogging path is beloved by locals."},"하카타 돈코츠 라멘":{name:"Hakata Tonkotsu Ramen",desc:"Fukuoka's soul food with rich pork bone broth. Ichiran and Ippudo are world-famous ramen chains born here."}}},
ja:{description:"福岡は九州最大の都市で、豚骨ラーメンと屋台文化で日本美食旅行の聖地です。韓国から最も近い日本の大都市でアクセスが優れています。",spots:{"나카스 야타이":{name:"中洲屋台",desc:"博多川沿いに並ぶ屋台街で福岡ならではの独特な文化です。豚骨ラーメン、焼き鳥、おでんを楽しみながら地元の人と交流できます。"},"다자이후 텐만구":{name:"太宰府天満宮",desc:"学問の神様菅原道真を祀る神社で毎年受験生の参拝が続きます。参道の梅ヶ枝餅が名物です。"},"캐널시티 하카타":{name:"キャナルシティ博多",desc:"中央の運河と噴水ショーが印象的な巨大ショッピング・エンターテインメント複合施設です。ラーメンスタジアムで全国のラーメンを味わえます。"},"오호리 공원":{name:"大濠公園",desc:"福岡中心部にある美しい湖の公園で、日本庭園と美術館があります。2kmのジョギングコースが市民に愛されています。"},"하카타 돈코츠 라멘":{name:"博多豚骨ラーメン",desc:"福岡のソウルフードで濃厚な豚骨スープが特徴です。一蘭や一風堂など世界的に有名なラーメンチェーンがここから生まれました。"}}},
zh:{description:"福冈是九州最大城市，以猪骨拉面和屋台（大排档）文化成为日本美食旅行圣地。是离韩国最近的日本大城市，交通便利。",spots:{"나카스 야타이":{name:"中洲屋台",desc:"博多川沿岸排列的大排档街，展现福冈独特文化。可边享用猪骨拉面、烤鸡串、关东煮边与当地人交流。"},"다자이후 텐만구":{name:"太宰府天满宫",desc:"供奉学问之神菅原道真的神社，每年考生参拜络绎不绝。参道的梅枝饼是特产。"},"캐널시티 하카타":{name:"博多运河城",desc:"拥有壮观中央运河和喷泉秀的大型购物娱乐综合体。拉面竞技场可品尝全国拉面。"},"오호리 공원":{name:"大濠公园",desc:"福冈市中心的美丽湖泊公园，有日式庭园和美术馆。2公里慢跑道深受市民喜爱。"},"하카타 돈코츠 라멘":{name:"博多猪骨拉面",desc:"福冈灵魂美食，浓郁猪骨汤是特色。一蘭、一风堂等世界知名拉面连锁都诞生于此。"}}}
},

// ── 히로시마 ──
"히로시마":{
en:{description:"Hiroshima is a moving city that rose as a city of peace after overcoming the tragedy of the atomic bomb. The Peace Memorial Park and nearby Miyajima Island's floating torii are representative tourist sites.",spots:{"원폭 돔":{name:"Atomic Bomb Dome",desc:"A UNESCO World Heritage site conveying the horror of the 1945 atomic bombing. A symbol of anti-war and peace visited by people worldwide."},"이츠쿠시마 신사(미야지마)":{name:"Itsukushima Shrine (Miyajima)",desc:"A UNESCO World Heritage shrine famous for its large vermilion torii gate appearing to float on the sea. The scenery at high tide with the torii submerged is magical."},"히로시마 평화기념관":{name:"Hiroshima Peace Memorial Museum",desc:"A museum displaying artifacts and records of atomic bomb victims. A deeply moving place to feel the preciousness of peace."},"히로시마풍 오코노미야키":{name:"Hiroshima-style Okonomiyaki",desc:"Hiroshima's unique layered okonomiyaki. The Okonomi-mura building houses dozens of specialty shops."},"평화기념공원":{name:"Peace Memorial Park",desc:"A park built at the hypocenter of the atomic bomb. The cenotaph and Children's Peace Monument are solemn."}}},
ja:{description:"広島は原爆の悲劇を乗り越えて平和の都市として復活した感動的な場所です。平和記念公園と近くの宮島の海上鳥居が代表的な観光地です。",spots:{"원폭 돔":{name:"原爆ドーム",desc:"1945年の原子爆弾投下の惨状を伝える世界文化遺産です。反戦と平和の象徴として世界中の人が訪れます。"},"이츠쿠시마 신사(미야지마)":{name:"厳島神社(宮島)",desc:"海に浮かぶような朱色の大鳥居で有名な世界文化遺産です。満潮時に海に沈んだ鳥居の風景が幻想的です。"},"히로시마 평화기념관":{name:"広島平和記念資料館",desc:"原爆被害者の遺品と記録を展示した資料館で、平和の尊さを深く感じられます。訪問後に大きな余韻が残る場所です。"},"히로시마풍 오코노미야키":{name:"広島風お好み焼き",desc:"広島特有の重ね焼きのお好み焼きを味わえます。お好み村ビルに数十軒の専門店が集まっています。"},"평화기념공원":{name:"平和記念公園",desc:"原爆投下の爆心地に建てられた公園です。慰霊碑と原爆の子の像が厳粛です。"}}},
zh:{description:"广岛是克服原子弹悲剧后重生为和平之城的感人之地。和平纪念公园和附近宫岛的海上鸟居是代表性旅游景点。",spots:{"원폭 돔":{name:"原爆圆顶馆",desc:"传达1945年原子弹轰炸惨状的世界文化遗产。作为反战与和平的象征，全世界人民前来参观。"},"이츠쿠시마 신사(미야지마)":{name:"严岛神社（宫岛）",desc:"以仿佛漂浮在海上的朱红色大鸟居闻名的世界文化遗产。涨潮时鸟居浸入海中的景象如梦似幻。"},"히로시마 평화기념관":{name:"广岛和平纪念资料馆",desc:"展示原子弹受害者遗物和记录的资料馆，可深切感受和平的珍贵。参观后余韵深长。"},"히로시마풍 오코노미야키":{name:"广岛式御好烧",desc:"广岛特有的层层叠加的御好烧。御好村大楼内汇集了数十家专门店。"},"평화기념공원":{name:"和平纪念公园",desc:"建在原子弹爆炸中心的公园。慰灵碑和原爆之子雕像庄严肃穆。"}}}
},

// ── 고베 ──
"고베":{
en:{description:"Kobe is an exotic port city with charm since its opening, the birthplace of world-renowned Kobe beef wagyu. It features beautiful cityscape nestled between mountains and sea.",spots:{"고베 포트타워":{name:"Kobe Port Tower",desc:"A red observation tower landmark of Kobe Port offering 360-degree views of the port and city. Night views are especially beautiful."},"기타노 이진칸":{name:"Kitano Ijinkan",desc:"Western-style mansions where foreigners lived during the port opening era. Great for comparing various national architectural styles while strolling."},"고베 비프 스테이크":{name:"Kobe Beef Steak",desc:"A special experience tasting Kobe beef, one of the world's three great wagyu, in its hometown. Grilled teppanyaki-style right before your eyes."},"아리마 온천":{name:"Arima Onsen",desc:"One of Japan's three great hot springs with over 1,000 years of history. Famous for two types of water: golden Kinsen and clear Ginsen."},"난킨마치(차이나타운)":{name:"Nankinmachi Chinatown",desc:"One of Japan's three major Chinatowns. Always bustling with Chinese restaurants and street food stalls."}}},
ja:{description:"神戸は開港以来異国情緒あふれる港町で、世界的な和牛「神戸ビーフ」の本場です。山と海の間に位置する美しい都市景観が特徴です。",spots:{"고베 포트타워":{name:"神戸ポートタワー",desc:"神戸港のランドマークである赤い展望タワーで、港と市街地を360度眺められます。夜景が特に美しいです。"},"기타노 이진칸":{name:"北野異人館",desc:"開港当時に外国人が住んでいた西洋式邸宅が集まる異国情緒ある街です。各国の建築様式を比較しながら散策するのが良いです。"},"고베 비프 스테이크":{name:"神戸ビーフステーキ",desc:"世界三大和牛の一つである神戸ビーフを本場で味わう特別な体験です。鉄板焼きスタイルで目の前で焼いてくれます。"},"아리마 온천":{name:"有馬温泉",desc:"日本三大名泉の一つで1,000年以上の歴史を誇ります。金色の金泉と透明な銀泉の二種類の温泉水が有名です。"},"난킨마치(차이나타운)":{name:"南京町(チャイナタウン)",desc:"日本三大中華街の一つです。中華料理店や屋台グルメで常に賑わっています。"}}},
zh:{description:"神户是开埠以来异国情调迷人的港口城市，是世界著名和牛神户牛肉的发源地。山海之间的美丽城市景观是其特色。",spots:{"고베 포트타워":{name:"神户港塔",desc:"神户港的地标红色观景塔，可360度俯瞰港口和市区。夜景尤为美丽。"},"기타노 이진칸":{name:"北野异人馆",desc:"开埠时期外国人居住的西洋式宅邸汇集的异国风情街区。适合一边比较各国建筑风格一边散步。"},"고베 비프 스테이크":{name:"神户牛排",desc:"在发源地品尝世界三大和牛之一神户牛肉的特别体验。铁板烧方式在眼前烹制。"},"아리마 온천":{name:"有马温泉",desc:"日本三大名泉之一，拥有1000多年历史。以金色的金泉和透明的银泉两种温泉水闻名。"},"난킨마치(차이나타운)":{name:"南京町（唐人街）",desc:"日本三大唐人街之一。中餐馆和街头美食摊位总是热闹非凡。"}}}
},


// ── 오키나와 ──
"오키나와":{
en:{description:"Okinawa is Japan's southernmost subtropical islands with emerald seas and unique Ryukyu culture. You can experience a completely different Japan through diving, snorkeling, and traditional music.",spots:{"슈리성":{name:"Shuri Castle",desc:"A UNESCO World Heritage former royal palace of the Ryukyu Kingdom, under reconstruction after a 2019 fire. Features unique architecture blending Chinese and Japanese styles."},"추라우미 수족관":{name:"Okinawa Churaumi Aquarium",desc:"An aquarium where whale sharks and manta rays swim in one of the world's largest tanks. One of Okinawa's top tourist attractions."},"만좌모":{name:"Cape Manzamo",desc:"Spectacular cliffs shaped like an elephant's trunk with clear blue waters. Especially beautiful at sunset, a top Okinawa photo spot."},"국제거리":{name:"Kokusai Street",desc:"Naha's main 1.6km street filled with Okinawa souvenirs and foods. Sugarcane ice cream and shisa (lion statues) are popular."},"비세 후쿠기 나무 터널":{name:"Bise Fukugi Tree Tunnel",desc:"A mystical forest path lined with 300-year-old fukugi trees. The emerald-green sunlight filtering through creates a magical atmosphere."}}},
ja:{description:"沖縄は日本最南端の亜熱帯の島で、エメラルドの海と独自の琉球文化が魅力です。ダイビング、シュノーケリング、伝統音楽など本土とは全く異なる日本を体験できます。",spots:{"슈리성":{name:"首里城",desc:"琉球王国の王宮だった世界文化遺産で、2019年の火災後復元中です。中国と日本の建築が融合した独特な様式が特徴です。"},"추라우미 수족관":{name:"美ら海水族館",desc:"世界最大級の水槽でジンベエザメやマンタが遊泳する姿を見られる水族館です。沖縄最高の観光地の一つです。"},"만좌모":{name:"万座毛",desc:"象の鼻のような奇岩と透明な海が織りなす絶景です。夕暮れが特に美しく沖縄を代表するフォトスポットです。"},"국제거리":{name:"国際通り",desc:"那覇市内約1.6kmのメインストリートで沖縄土産と食べ物がいっぱいです。サトウキビアイスとシーサー土産が人気です。"},"비세 후쿠기 나무 터널":{name:"備瀬のフクギ並木",desc:"樹齢300年のフクギの木が並ぶ神秘的な森の道です。緑のエメラルドの太陽光が幻想的な雰囲気を作ります。"}}},
zh:{description:"冲绳是日本最南端的亚热带岛屿，拥有翡翠色大海和独特的琉球文化。可通过潜水、浮潜、传统音乐等体验与本土完全不同的日本。",spots:{"슈리성":{name:"首里城",desc:"琉球王国王宫所在的世界文化遗产，2019年火灾后正在重建中。融合中国和日本建筑的独特风格是其特色。"},"추라우미 수족관":{name:"美丽海水族馆",desc:"世界最大级别水槽中可观赏鲸鲨和蝠鲼游弋的水族馆。是冲绳顶级旅游景点之一。"},"만좌모":{name:"万座毛",desc:"形似象鼻的奇岩与清澈海水交织的绝景。日落时分尤为美丽，是冲绳代表性拍照点。"},"국제거리":{name:"国际通",desc:"那霸市内约1.6公里的主街道，充满冲绳特产和美食。甘蔗冰淇淋和狮子像纪念品很受欢迎。"},"비세 후쿠기 나무 터널":{name:"备濑福木林荫道",desc:"树龄300年的福木树排列的神秘森林小路。翡翠绿色的阳光营造出梦幻氛围。"}}}
},

// ── 가나자와 ──
"가나자와":{
en:{description:"Kanazawa is the jewel of Hokuriku, famous for Kenrokuen, one of Japan's three great gardens, and preserved Edo period streets. It's a cultural city where traditional crafts and seafood culture are well preserved.",spots:{"겐로쿠엔":{name:"Kenroku-en Garden",desc:"One of Japan's three great gardens showcasing different beauty in each season. The winter yukitsuri (snow-supporting ropes) are particularly iconic."},"히가시 차야가이":{name:"Higashi Chaya District",desc:"A traditional teahouse district preserving the atmosphere of Edo period geisha quarters. Gold leaf ice cream and traditional sweets are specialties."},"가나자와성":{name:"Kanazawa Castle",desc:"The castle of the Maeda clan with beautiful white walls. The reconstructed castle towers and gates are impressive."},"21세기 미술관":{name:"21st Century Museum",desc:"A circular modern art museum. Leandro Erlich's 'Swimming Pool' is a must-see."},"오미초 시장":{name:"Omicho Market",desc:"Kanazawa's kitchen with 300 years of history. Fresh seafood from the Sea of Japan, especially winter crab, is famous."}}},
ja:{description:"金沢は日本三名園の兼六園と保存された江戸時代の街並みで有名な北陸の宝石です。伝統工芸と海産物文化がよく保存された文化都市です。",spots:{"겐로쿠엔":{name:"兼六園",desc:"日本三名園の一つで四季折々の異なる美しさを見せます。特に冬の雪吊りが象徴的です。"},"히가시 차야가이":{name:"東茶屋街",desc:"江戸時代の花街の雰囲気をそのまま保った伝統的な茶屋街です。金箔アイスクリームと伝統和菓子が名物です。"},"가나자와성":{name:"金沢城",desc:"前田氏の居城で美しい白壁が特徴です。復元された櫓や門が見事です。"},"21세기 미술관":{name:"金沢21世紀美術館",desc:"円形の現代美術館です。レアンドロ・エルリッヒの「スイミング・プール」は必見です。"},"오미초 시장":{name:"近江町市場",desc:"300年の歴史を持つ金沢の台所です。日本海の新鮮な海産物、特に冬のカニが有名です。"}}},
zh:{description:"金泽是以日本三大名园之一的兼六园和保存完好的江户时代街区而闻名的北陆瑰宝。是传统工艺和海鲜文化保存良好的文化城市。",spots:{"겐로쿠엔":{name:"兼六园",desc:"日本三大名园之一，四季呈现不同美景。冬季的雪吊尤为标志性。"},"히가시 차야가이":{name:"东茶屋街",desc:"保存江户时代艺妓街氛围的传统茶屋街区。金箔冰淇淋和传统和果子是特产。"},"가나자와성":{name:"金泽城",desc:"前田氏的居城，美丽的白墙是其特色。重建的城楼和城门令人印象深刻。"},"21세기 미술관":{name:"21世纪美术馆",desc:"圆形的现代美术馆。莱安德罗·埃利希的《游泳池》是必看作品。"},"오미초 시장":{name:"近江町市场",desc:"拥有300年历史的金泽厨房。日本海的新鲜海产品，尤其是冬季螃蟹很有名。"}}}
},

// ── 하코네 ──
"하코네":{
en:{description:"Hakone is a hot spring resort town just an hour from Tokyo, famous for views of Mt. Fuji, open-air baths, and art museums. The journey itself by ropeway, cruise ship, and mountain railway is sightseeing.",spots:{"아시노코 호수":{name:"Lake Ashi",desc:"A volcanic lake where pirate ship cruises operate with Mt. Fuji as backdrop. On clear days, the inverted Mt. Fuji reflection on the lake is spectacular."},"오와쿠다니":{name:"Owakudani",desc:"A sulfur fumarole area formed by a volcanic eruption 3,000 years ago. Legend says eating black eggs boiled in sulfur extends your life by 7 years."},"하코네 조각의 숲 미술관":{name:"Hakone Open-Air Museum",desc:"An outdoor museum with sculptures and a Picasso pavilion. A unique space where nature and art blend."},"하코네 유모토 온천":{name:"Hakone Yumoto Onsen",desc:"The gateway to Hakone with numerous hot spring ryokans and day-use onsen facilities. Offers the best onsen experience near Tokyo."},"하코네 로프웨이":{name:"Hakone Ropeway",desc:"A ropeway offering spectacular views of Mt. Fuji and Lake Ashi. The journey to Owakudani itself is an attraction."}}},
ja:{description:"箱根は東京から1時間の温泉リゾート地で、富士山の眺望と露天風呂、美術館で有名です。ロープウェイ、遊覧船、登山電車での移動自体が観光です。",spots:{"아시노코 호수":{name:"芦ノ湖",desc:"富士山を背景に海賊船遊覧船が運航する火山湖です。晴れた日には湖に映る逆さ富士が絶景です。"},"오와쿠다니":{name:"大涌谷",desc:"約3,000年前の火山噴火で形成された硫黄噴気地帯です。硫黄で茹でた黒卵を食べると7年寿命が延びるという伝説があります。"},"하코네 조각의 숲 미술관":{name:"箱根彫刻の森美術館",desc:"屋外に彫刻作品が展示された美術館で、ピカソ館もあります。自然と芸術が調和した独特な空間です。"},"하코네 유모토 온천":{name:"箱根湯本温泉",desc:"箱根の玄関口で数多くの温泉旅館と日帰り温泉施設が集まっています。東京近郊で最高の温泉体験ができます。"},"하코네 로프웨이":{name:"箱根ロープウェイ",desc:"富士山と芦ノ湖の壮観な眺めを楽しめるロープウェイです。大涌谷への移動自体が見どころです。"}}},
zh:{description:"箱根是距东京1小时车程的温泉度假胜地，以富士山景观、露天温泉和美术馆闻名。乘坐缆车、游船、登山电车的过程本身就是观光。",spots:{"아시노코 호수":{name:"芦之湖",desc:"以富士山为背景的火山湖，有海盗船游船运行。晴天时湖中倒映的逆富士景观壮丽。"},"오와쿠다니":{name:"大涌谷",desc:"约3000年前火山喷发形成的硫磺喷气地带。传说吃用硫磺煮的黑鸡蛋可以延寿7年。"},"하코네 조각의 숲 미술관":{name:"箱根雕刻之森美术馆",desc:"户外展示雕塑作品的美术馆，还有毕加索馆。是自然与艺术融合的独特空间。"},"하코네 유모토 온천":{name:"箱根汤本温泉",desc:"箱根的门户，汇集了众多温泉旅馆和一日游温泉设施。可体验东京近郊最好的温泉。"},"하코네 로프웨이":{name:"箱根空中缆车",desc:"可欣赏富士山和芦之湖壮观景色的缆车。前往大涌谷的过程本身就是看点。"}}}
},
...
// ── 시안 ──
"시안":{
en:{description:"Xi'an, the capital of 13 dynasties, is the cradle of ancient Chinese civilization and home to the Terracotta Army of Emperor Qin Shi Huang. It was the starting point of the Silk Road, a crossroads of Eastern and Western cultures.",spots:{"진시황 병마용":{name:"Terracotta Army",desc:"8,000 life-sized soldier sculptures guarding Emperor Qin Shi Huang's tomb from 2,200 years ago. Considered the greatest archaeological discovery of the 20th century, it's a UNESCO World Heritage Site."},"시안 성벽":{name:"Xi'an City Wall",desc:"The best-preserved ancient city wall in China from the Ming Dynasty, spanning 14km. You can bike along the wall while overlooking the city."},"대안탑(대기러기탑)":{name:"Giant Wild Goose Pagoda",desc:"A 7-story pagoda built by Tang Dynasty monk Xuanzang to store Buddhist scriptures brought from India. A 1,300-year-old symbol of Xi'an."},"회민가(무슬림 거리)":{name:"Muslim Quarter",desc:"Xi'an's signature food street where you can taste Northwestern Chinese cuisine like lamb skewers, liangpi (cold noodles), and biangbiang noodles. The night market becomes even more vibrant after dark."},"종고루·고루":{name:"Bell and Drum Towers",desc:"Ming Dynasty towers at the city center. Traditional drum performances are held daily at the Drum Tower."}}},
ja:{description:"西安は13の王朝の都だった中国古代文明の揺籃で、秦始皇帝兵馬俑がある歴史都市です。シルクロードの出発点として東西文化の交差点でした。",spots:{"진시황 병마용":{name:"秦始皇帝兵馬俑",desc:"2,200年前の秦始皇帝の墓を守る8,000体余りの実物大兵士彫刻です。20世紀最大の考古学的発見とされる世界文化遺産です。"},"시안 성벽":{name:"西安城壁",desc:"明代に築かれた中国で最もよく保存された古代城壁で、周囲14kmです。城壁の上で自転車に乗りながら西安市内を眺められます。"},"대안탑(대기러기탑)":{name:"大雁塔",desc:"唐代の玄奘法師がインドから持ち帰った仏経を保管するために建てた7層の塔です。1,300年の歴史を持つ西安のシンボルです。"},"회민가(무슬림 거리)":{name:"回民街(ムスリム街)",desc:"西安を代表する食の街で、羊串、涼皮(冷麺)、ビャンビャン麺など西北中国料理を味わえます。夜になるとさらに活気ある夜市になります。"},"종고루·고루":{name:"鐘楼・鼓楼",desc:"市の中心にある明代の楼閣です。鼓楼では毎日伝統的な太鼓の公演が行われます。"}}},
zh:{description:"西安是13个王朝的古都，是中国古代文明的摇篮，拥有秦始皇兵马俑的历史名城。作为丝绸之路的起点，是东西方文化的交汇处。",spots:{"진시황 병마용":{name:"秦始皇兵马俑",desc:"距今2200年前守卫秦始皇陵墓的8000余尊真人大小的士兵雕塑。被誉为20世纪最伟大的考古发现，联合国教科文组织世界文化遗产。"},"시안 성벽":{name:"西安古城墙",desc:"明代修建的中国保存最完整的古代城墙，周长14公里。可在城墙上骑自行车俯瞰西安城。"},"대안탑(대기러기탑)":{name:"大雁塔",desc:"唐代玄奘法师为保存从印度取回的佛经而建的七层宝塔。拥有1300年历史的西安标志性建筑。"},"회민가(무슬림 거리)":{name:"回民街",desc:"西安代表性美食街，可品尝羊肉串、凉皮、biangbiang面等西北中国美食。夜晚的夜市更加热闹。"},"종고루·고루":{name:"钟楼·鼓楼",desc:"市中心的明代楼阁。鼓楼每天举行传统鼓乐表演。"}}}
},

// ── 구이린 ──
"구이린":{
en:{description:"Guilin is a city of world-class scenery where karst mountains unfold like an ink painting along the Li River. The landscape is so beautiful it appears on the 20-yuan note.",spots:{"리강 유람":{name:"Li River Cruise",desc:"An 83km cruise from Guilin to Yangshuo is one of China's finest scenery experiences. Bizarre peaks and clear river water create a living landscape painting."},"양숴 서가":{name:"Yangshuo West Street",desc:"A small village surrounded by karst peaks, perfect for cycling through countryside scenery. The cafes and restaurants on West Street are charming."},"상비산":{name:"Elephant Trunk Hill",desc:"A peculiar rock formation resembling an elephant drinking water, symbolizing Guilin. Located by the Li River, easily accessible from downtown Guilin."},"룽지 다랭이 논":{name:"Longji Rice Terraces",desc:"Terraced rice fields carved into mountain slopes, meaning 'Dragon's Backbone.' The golden autumn harvest scenery is magnificent."},"은암(은자암)":{name:"Silver Cave",desc:"A massive limestone cave with spectacular stalactites and stalagmites. The underground wonderland stretches for 2km."}}},
ja:{description:"桂林は水墨画のようなカルスト地形が漓江に沿って広がる世界的な絶景の都市です。中国20元紙幣の背景になるほど美しい自然景観を誇ります。",spots:{"리강 유람":{name:"漓江下り",desc:"桂林から陽朔まで約83kmの漓江下りは中国最高の風景の一つです。奇妙な峰と澄んだ川が一幅の山水画を成します。"},"양숴 서가":{name:"陽朔西街",desc:"カルストの峰に囲まれた小さな村で、自転車で田園風景を楽しむのに最適です。西街のカフェやレストランも魅力的です。"},"상비산":{name:"象鼻山",desc:"象が水を飲む姿の奇岩で桂林のシンボルです。漓江沿いにあり桂林市内から簡単に訪れられます。"},"룽지 다랭이 논":{name:"龍脊棚田",desc:"山腹に沿って層々に造成された段々畑で、龍の背骨という意味です。収穫期の秋に黄金色に染まる風景が壮観です。"},"은암(은자암)":{name:"銀子岩",desc:"壮大な鍾乳洞で見事な鍾乳石と石筍があります。地下の不思議な世界が2km続きます。"}}},
zh:{description:"桂林是喀斯特地貌沿漓江展开如水墨画般的世界级美景之城。美到成为中国20元人民币背景的自然景观。",spots:{"리강 유람":{name:"漓江游船",desc:"从桂林到阳朔约83公里的漓江游船是中国最美的风景之一。奇峰与清澈江水构成一幅山水画卷。"},"양숴 서가":{name:"阳朔西街",desc:"被喀斯特峰林环绕的小镇，骑自行车欣赏田园风光最为惬意。西街的咖啡馆和餐厅也颇具魅力。"},"상비산":{name:"象鼻山",desc:"形似大象饮水的奇石，是桂林的象征。位于漓江畔，从桂林市区可轻松到达。"},"룽지 다랭이 논":{name:"龙脊梯田",desc:"沿山坡层层开垦的梯田，意为龙的脊梁。秋季收获时节金黄色的景色蔚为壮观。"},"은암(은자암)":{name:"银子岩",desc:"壮观的溶洞，钟乳石和石笋令人叹为观止。地下奇观绵延2公里。"}}}
},

// ── 청두 ──
"청두":{
en:{description:"Chengdu is the capital of Sichuan Province, home to adorable giant pandas and the origin of spicy Sichuan cuisine. As a UNESCO City of Gastronomy, it boasts rich culinary culture including mapo tofu and hotpot.",spots:{"청두 판다 번식 연구기지":{name:"Chengdu Research Base of Giant Panda Breeding",desc:"Over 100 giant pandas can be observed in near-natural environments. A world-popular tourist destination where you can see baby pandas."},"진리 고거리":{name:"Jinli Ancient Street",desc:"A traditional street next to Wuhou Shrine from the Three Kingdoms era, filled with Sichuan-style architecture, food, and crafts. Particularly beautiful at night when red lanterns are lit."},"쓰촨 훠궈":{name:"Sichuan Hotpot",desc:"Sichuan hotpot with mala (numbing-spicy) broth is China's ultimate dining experience. The tingling Sichuan peppercorn flavor is addictive."},"르서우(인민공원)":{name:"People's Park",desc:"A downtown park offering a glimpse into Chengdu citizens' lives, with impressive teahouse culture where people leisurely sip tea. The matchmaking corner is also famous."},"무후사(삼국지 박물관)":{name:"Wuhou Shrine",desc:"A temple honoring Zhuge Liang and Liu Bei from the Three Kingdoms period. A must-visit for fans of the Romance of the Three Kingdoms."}}},
ja:{description:"成都は四川省の省都で、かわいいジャイアントパンダと辛い四川料理の本場です。ユネスコ美食創意都市として麻婆豆腐、火鍋など豊かな美食文化を誇ります。",spots:{"청두 판다 번식 연구기지":{name:"成都ジャイアントパンダ繁殖研究基地",desc:"100頭以上のジャイアントパンダを自然に近い環境で観察できます。赤ちゃんパンダを見られる世界的人気観光地です。"},"진리 고거리":{name:"錦里古街",desc:"三国志の武侯祠の隣にある伝統的な街で、四川式建築と食べ物、工芸品がいっぱいです。夜に赤い灯籠が灯ると特に美しいです。"},"쓰촨 훠궈":{name:"四川火鍋",desc:"麻辣スープに各種食材を入れて食べる四川火鍋は中国最高の美食体験です。ピリピリする花椒の香りが中毒的です。"},"르서우(인민공원)":{name:"人民公園",desc:"成都市民の生活を垣間見られる都心の公園で、お茶を飲みながらくつろぐ茶館文化が印象的です。お見合いコーナーも有名です。"},"무후사(삼국지 박물관)":{name:"武侯祠",desc:"三国時代の諸葛亮と劉備を祀る祠です。三国志のファンにとって必見の場所です。"}}},
zh:{description:"成都是四川省省会，可爱的大熊猫和麻辣川菜的发源地。作为联合国教科文组织美食之都，麻婆豆腐、火锅等美食文化丰富多彩。",spots:{"청두 판다 번식 연구기지":{name:"成都大熊猫繁育研究基地",desc:"可在接近自然的环境中观察100多只大熊猫。是可以看到熊猫宝宝的世界知名旅游景点。"},"진리 고거리":{name:"锦里古街",desc:"位于武侯祠旁的传统街区，川式建筑、美食、工艺品应有尽有。夜晚红灯笼亮起时尤为美丽。"},"쓰촨 훠궈":{name:"四川火锅",desc:"在麻辣汤底中涮煮各种食材的四川火锅是中国最极致的美食体验。花椒的麻味令人上瘾。"},"르서우(인민공원)":{name:"人民公园",desc:"可一窥成都市民生活的市中心公园，喝茶闲聊的茶馆文化令人印象深刻。相亲角也很有名。"},"무후사(삼국지 박물관)":{name:"武侯祠",desc:"供奉三国时期诸葛亮和刘备的祠堂。是三国演义粉丝的必游之地。"}}}
},


// ── 항저우 ──
"항저우":{
en:{description:"Hangzhou was praised by Marco Polo as the most beautiful city in the world, famous for West Lake scenery. It's also the birthplace of Longjing tea and home to Alibaba headquarters, making it an IT city.",spots:{"서호(시후)":{name:"West Lake",desc:"A UNESCO World Heritage lake where pavilions, pagodas, bridges, and willows around the lake create an ink painting. Best enjoyed from a boat cruise."},"링인사(영은사)":{name:"Lingyin Temple",desc:"One of China's ten great temples with 1,700 years of history, featuring giant Buddha carvings and serene atmosphere. The stone carvings at Feilai Peak are also must-sees."},"용정차 마을":{name:"Longjing Tea Village",desc:"Birthplace of China's finest green tea, Longjing (Dragon Well) tea, where you can sample freshly picked tea while walking through tea plantations. Spring around Qingming Festival is optimal."},"허팡제(하방가)":{name:"Hefang Street",desc:"A traditional commercial street recreating Southern Song Dynasty architecture, offering Hangzhou specialty snacks, tea, and crafts. Dongpo pork and other Hangzhou dishes are available."},"뇌봉탑":{name:"Leifeng Pagoda",desc:"A pagoda associated with the White Snake legend, offering panoramic views of West Lake from the top. Especially beautiful at sunset."}}},
ja:{description:"杭州はマルコ・ポーロが世界で最も美しい都市と絶賛した場所で、西湖の絶景で有名です。龍井茶の産地でありアリババ本社があるIT都市でもあります。",spots:{"서호(시후)":{name:"西湖",desc:"ユネスコ世界文化遺産で、湖の周りの亭、塔、橋、柳が一幅の水墨画を成します。遊覧船で巡るのが最高です。"},"링인사(영은사)":{name:"霊隠寺",desc:"1,700年の歴史を持つ中国十大寺院の一つで、巨大な石仏彫刻と静謐な雰囲気が印象的です。飛来峰の石刻群も必須コースです。"},"용정차 마을":{name:"龍井茶村",desc:"中国最高級緑茶である龍井(ロンジン)茶の産地で、茶畑の間を歩きながら摘みたてのお茶を試飲できます。春の清明節頃が最適期です。"},"허팡제(하방가)":{name:"河坊街",desc:"南宋時代の街並みを再現した伝統商業街で、杭州の特産間食とお茶、工芸品を楽しめます。東坡肉など杭州料理も味わえます。"},"뇌봉탑":{name:"雷峰塔",desc:"白蛇伝説ゆかりの塔で、頂上から西湖全体を一望できます。夕暮れ時が特に美しいです。"}}},
zh:{description:"杭州是马可·波罗盛赞为世界上最美丽的城市，以西湖美景闻名。也是龙井茶的产地和阿里巴巴总部所在地，是IT之城。",spots:{"서호(시후)":{name:"西湖",desc:"联合国教科文组织世界文化遗产，湖畔的亭台楼阁、桥梁、杨柳构成一幅水墨画。乘游船游览是最佳方式。"},"링인사(영은사)":{name:"灵隐寺",desc:"拥有1700年历史的中国十大寺院之一，巨大的石佛雕刻和宁静氛围令人印象深刻。飞来峰石刻群也是必看景点。"},"용정차 마을":{name:"龙井茶村",desc:"中国顶级绿茶龙井茶的产地，可边漫步茶园边品尝刚采摘的茶叶。春季清明节前后是最佳时期。"},"허팡제(하방가)":{name:"河坊街",desc:"再现南宋时代街景的传统商业街，可享用杭州特色小吃、茶叶和工艺品。还可品尝东坡肉等杭州菜。"},"뇌봉탑":{name:"雷峰塔",desc:"与白蛇传说相关的宝塔，从塔顶可俯瞰西湖全景。黄昏时分尤为美丽。"}}}
},

// ── 장자제 ──
"장자제":{
en:{description:"Zhangjiajie inspired the Hallelujah Mountains in Avatar, with thousands of sandstone pillars rising above the clouds in a stunning landscape. It's China's first national forest park.",spots:{"장자제 국가삼림공원":{name:"Zhangjiajie National Forest Park",desc:"China's first national forest park and a UNESCO World Heritage site. Over 3,000 quartzite sandstone pillars create an otherworldly landscape."},"천문산":{name:"Tianmen Mountain",desc:"Famous for Tianmen Cave, the world's highest natural arch. The 99-bend road and glass skywalk are thrilling attractions."},"베이리화랑(금편계곡)":{name:"Golden Whip Stream",desc:"A peaceful 7km valley trail along a crystal-clear stream. One of Zhangjiajie's most beautiful and accessible hikes."},"천자산":{name:"Tianzi Mountain",desc:"Meaning 'Son of Heaven Mountain,' it offers the best panoramic views of the stone forest peaks."},"백룡 엘리베이터":{name:"Bailong Elevator",desc:"The world's tallest outdoor elevator built into a cliff face, ascending 326m in less than 2 minutes."}}},
ja:{description:"張家界は映画「アバター」のハレルヤ山のモチーフとなった場所で、数千本の砂岩の柱が雲の上にそびえ立つ驚異的な風景です。中国初の国家森林公園です。",spots:{"장자제 국가삼림공원":{name:"張家界国家森林公園",desc:"中国初の国家森林公園でユネスコ世界自然遺産です。3,000本以上の石英砂岩の柱が異世界のような景観を作り出しています。"},"천문산":{name:"天門山",desc:"世界最高の天然アーチである天門洞で有名です。99曲がりの道とガラスの桟道がスリル満点です。"},"베이리화랑(금편계곡)":{name:"金鞭渓",desc:"澄んだ渓流沿いの平和な7kmの渓谷トレイルです。張家界で最も美しくアクセスしやすいハイキングコースの一つです。"},"천자산":{name:"天子山",desc:"天子の山を意味し、石林の峰々を最もよく見渡せるパノラマビューが楽しめます。"},"백룡 엘리베이터":{name:"百竜エレベーター",desc:"崖に建てられた世界一高い屋外エレベーターで、2分足らずで326m上昇します。"}}},
zh:{description:"张家界是电影《阿凡达》哈利路亚山的原型，数千根砂岩柱耸立云端的惊艳景观。是中国第一个国家森林公园。",spots:{"장자제 국가삼림공원":{name:"张家界国家森林公园",desc:"中国第一个国家森林公园，联合国教科文组织世界自然遗产。3000多根石英砂岩柱构成超现实景观。"},"천문산":{name:"天门山",desc:"以世界最高天然穿山溶洞——天门洞而闻名。99道弯的盘山公路和玻璃栈道惊险刺激。"},"베이리화랑(금편계곡)":{name:"金鞭溪",desc:"沿着清澈溪流的宁静7公里峡谷步道。是张家界最美且最易到达的徒步路线之一。"},"천자산":{name:"天子山",desc:"意为天子之山，可欣赏石林峰群的最佳全景。"},"백룡 엘리베이터":{name:"百龙天梯",desc:"建在悬崖上的世界最高户外电梯，不到2分钟上升326米。"}}}
},

// ── 리장 ──
"리장":{
en:{description:"Lijiang is an ancient Naxi ethnic town with a UNESCO World Heritage Old Town and the majestic scenery of Jade Dragon Snow Mountain. It's a place where minority culture thrives.",spots:{"리장 고성":{name:"Lijiang Old Town",desc:"A UNESCO World Heritage ancient town with over 800 years of history. Cobblestone streets, canals, and Naxi architecture create a dreamlike atmosphere."},"위롱쉐산(옥룡설산)":{name:"Jade Dragon Snow Mountain",desc:"A sacred mountain of the Naxi people with 13 peaks reaching 5,596m. The cable car ride and Blue Moon Valley are spectacular."},"샤시마을":{name:"Shuhe Ancient Town",desc:"A quieter, more authentic ancient town than Lijiang Old Town. Traditional tea houses and leather workshops preserve old ways."},"흑룡담공원":{name:"Black Dragon Pool Park",desc:"A park offering the classic postcard view of Jade Dragon Snow Mountain reflected in the pool. Especially beautiful on clear days."},"나시 고악":{name:"Naxi Ancient Music",desc:"Traditional Naxi music performances using ancient instruments. A unique cultural experience found only in Lijiang."}}},
ja:{description:"麗江はナシ族の古代都市でユネスコ世界文化遺産に登録された旧市街と玉龍雪山(ぎょくりゅうせつざん)の雄大な風景が魅力です。少数民族文化が息づく場所です。",spots:{"리장 고성":{name:"麗江古城",desc:"800年以上の歴史を持つユネスコ世界文化遺産の古都です。石畳の道、運河、ナシ族建築が夢のような雰囲気を作り出しています。"},"위롱쉐산(옥룡설산)":{name:"玉龍雪山",desc:"ナシ族の聖山で、13の峰々が標高5,596mに達します。ロープウェイと藍月谷が壮観です。"},"샤시마을":{name:"束河古鎮",desc:"麗江古城より静かで本格的な古鎮です。伝統的な茶館や革工房が昔ながらの方法を保存しています。"},"흑룡담공원":{name:"黒竜潭公園",desc:"池に映る玉龍雪山の絵葉書のような風景が楽しめる公園です。晴れた日が特に美しいです。"},"나시 고악":{name:"納西古楽",desc:"古代の楽器を使ったナシ族の伝統音楽公演です。麗江でしか体験できない独特な文化体験です。"}}},
zh:{description:"丽江是纳西族古城，拥有列入联合国教科文组织世界文化遗产的古城和玉龙雪山的壮丽景色。是少数民族文化生生不息的地方。",spots:{"리장 고성":{name:"丽江古城",desc:"拥有800多年历史的联合国教科文组织世界文化遗产古城。石板路、水渠和纳西建筑营造梦幻氛围。"},"위롱쉐산(옥룡설산)":{name:"玉龙雪山",desc:"纳西族的神山，13座山峰海拔达5596米。缆车和蓝月谷景色壮观。"},"샤시마을":{name:"束河古镇",desc:"比丽江古城更安静、更原汁原味的古镇。传统茶馆和皮革作坊保留着古老工艺。"},"흑룡담공원":{name:"黑龙潭公园",desc:"可欣赏玉龙雪山倒映在池中如明信片般的景色的公园。晴天尤为美丽。"},"나시 고악":{name:"纳西古乐",desc:"使用古代乐器的纳西族传统音乐表演。只有在丽江才能体验的独特文化。"}}}
},

// ── 황산 ──
"황산":{
en:{description:"Huangshan is the origin of Chinese landscape painting, famous for the 'Four Wonders': peculiar pines, strange rocks, sea of clouds, and hot springs. It was a source of inspiration for countless poets and painters including Li Bai and Xu Xiake.",spots:{"황산 풍경구":{name:"Huangshan Scenic Area",desc:"A UNESCO World Heritage mountain famous for its uniquely shaped pine trees clinging to granite peaks. The sunrise view from the summit is breathtaking."},"서해대협곡":{name:"West Sea Grand Canyon",desc:"A dramatic gorge with cliffs and pine-covered peaks. The monorail train journey is an adventure in itself."},"광명정":{name:"Bright Summit Peak",desc:"Huangshan's second-highest peak at 1,860m, offering panoramic views of the famous 'sea of clouds.' Best visited at sunrise or sunset."},"옥병봉":{name:"Lotus Peak",desc:"Huangshan's highest peak at 1,864m, requiring a steep climb with chains. The 360-degree view from the top is worth the effort."},"굴곡":{name:"Tunxi Old Street",desc:"A well-preserved Ming and Qing dynasty commercial street at the base of Huangshan. Inkstones, tea, and local snacks are specialties."}}},
ja:{description:"黄山は中国山水画の原点で、奇松、怪石、雲海、温泉の四絶(よんぜつ)で有名です。李白、徐霞客など数多くの詩人や画家のインスピレーションの源でした。",spots:{"황산 풍경구":{name:"黄山風景区",desc:"花崗岩の峰に独特な形の松が生い茂るユネスコ世界遺産の山です。頂上からの日の出の眺めは息を呑むほど美しいです。"},"서해대협곡":{name:"西海大峡谷",desc:"断崖と松で覆われた峰々が織りなす劇的な渓谷です。モノレール列車の旅自体が冒険です。"},"광명정":{name:"光明頂",desc:"標高1,860mの黄山第二の高峰で、有名な「雲海」のパノラマビューが楽しめます。日の出か夕暮れの訪問がベストです。"},"옥병봉":{name:"蓮花峰",desc:"標高1,864mの黄山最高峰で、鎖を使った急な登りが必要です。頂上からの360度の眺めは努力に値します。"},"굴곡":{name:"屯溪老街",desc:"黄山麓にある明清時代の商業街がよく保存されています。硯、お茶、地元の間食が名物です。"}}},
zh:{description:"黄山是中国山水画的起源，以奇松、怪石、云海、温泉四绝闻名。是李白、徐霞客等众多诗人画家的灵感源泉。",spots:{"황산 풍景구":{name:"黄山风景区",desc:"独特松树攀附在花岗岩山峰上的联合国教科文组织世界遗产名山。山顶的日出美景令人叹为观止。"},"서해대협곡":{name:"西海大峡谷",desc:"悬崖峭壁与松林覆盖的山峰构成的壮观峡谷。单轨列车之旅本身就是一场冒险。"},"광명정":{name:"光明顶",desc:"海拔1860米的黄山第二高峰，可欣赏著名'云海'的全景。日出或日落时分参观最佳。"},"옥병봉":{name:"莲花峰",desc:"海拔1864米的黄山最高峰，需借助铁链攀登陡峭山路。山顶360度全景值得付出努力。"},"굴곡":{name:"屯溪老街",desc:"黄山脚下保存完好的明清商业街。砚台、茶叶和当地小吃是特产。"}}}
},

// ── 마카오 ──
"마카오":{
en:{description:"Macau is a unique city where European architecture from Portuguese colonial history coexists with the world's largest casino industry. The UNESCO World Heritage historic district is charming.",spots:{"세나도 광장":{name:"Senado Square",desc:"The heart of Macau's UNESCO Historic Centre with beautiful Portuguese-style wave-patterned pavement. Surrounded by colonial buildings."},"성 바울 성당 유적":{name:"Ruins of St. Paul's",desc:"Macau's most iconic landmark, the facade of a 17th-century Jesuit church. A UNESCO World Heritage site symbolizing East-West cultural fusion."},"베네치안 마카오":{name:"The Venetian Macao",desc:"One of the world's largest casinos with replicas of Venice's canals and gondolas inside. A massive entertainment complex."},"마카오 타워":{name:"Macau Tower",desc:"A 338m observation tower offering panoramic views of Macau and Zhuhai. The bungee jump and skywalk are for thrill-seekers."},"에그타르트":{name:"Portuguese Egg Tarts",desc:"Macau's signature snack, crispy pastry filled with creamy custard. Lord Stow's Bakery is the famous original."}}},
ja:{description:"マカオはポルトガル植民地時代の歴史が残したヨーロッパ風建築と世界最大のカジノ産業が共存する独特な都市です。ユネスコ世界文化遺産の歴史地区が魅力的です。",spots:{"세나도 광장":{name:"セナド広場",desc:"美しいポルトガル式の波模様の石畳があるマカオのユネスコ歴史地区の中心です。植民地時代の建物に囲まれています。"},"성 바울 성당 유적":{name:"聖ポール天主堂跡",desc:"マカオで最も象徴的なランドマークで、17世紀のイエズス会教会のファサードです。東西文化融合の象徴であるユネスコ世界文化遺産です。"},"베네치안 마카오":{name:"ザ・ヴェネチアン・マカオ",desc:"世界最大級のカジノで、内部にベニスの運河とゴンドラの複製があります。巨大なエンターテインメント複合施設です。"},"마카오 타워":{name:"マカオタワー",desc:"高さ338mの展望塔でマカオと珠海のパノラマビューを楽しめます。バンジージャンプとスカイウォークはスリルを求める人向けです。"},"에그타르트":{name:"エッグタルト",desc:"マカオの代表的な間食で、サクサクの生地にクリーミーなカスタードが詰まっています。ロード・ストーズ・ベーカリーが有名な元祖です。"}}},
zh:{description:"澳门是葡萄牙殖民历史留下的欧式建筑与世界最大赌场产业并存的独特城市。联合国教科文组织世界文化遗产历史城区颇具魅力。",spots:{"세나도 광장":{name:"议事亭前地",desc:"拥有美丽葡式波浪图案地砖的澳门联合国教科文组织历史城区的中心。被殖民地时期建筑环绕。"},"성 바울 성당 유적":{name:"大三巴牌坊",desc:"澳门最具标志性的地标，17世纪耶稣会教堂的前壁。象征东西文化交融的联合国教科文组织世界文化遗产。"},"베네치안 마카오":{name:"澳门威尼斯人",desc:"世界最大赌场之一，内部仿造威尼斯运河和贡多拉船。是大型娱乐综合体。"},"마카오 타워":{name:"澳门旅游塔",desc:"高338米的观景塔，可俯瞰澳门和珠海全景。蹦极和空中漫步是刺激项目。"},"에그타르트":{name:"葡式蛋挞",desc:"澳门代表性小吃，酥脆外皮包裹香浓蛋奶馅。安德鲁饼店是著名的元祖店。"}}}
},

// ── 쑤저우 ──
"쑤저우":{
en:{description:"Suzhou is called the 'Venice of the East' with 2,500 years of garden culture and beautiful canals. UNESCO-listed classical gardens showcase the essence of Chinese garden art.",spots:{"졸정원":{name:"Humble Administrator's Garden",desc:"China's largest and most famous classical garden, a UNESCO World Heritage site. Every season offers different scenery."},"호구(虎丘)":{name:"Tiger Hill",desc:"Known as 'the most scenic spot in Suzhou,' featuring the leaning Cloud Rock Pagoda and beautiful gardens. Rich in legends and history."},"평강로":{name:"Pingjiang Road",desc:"A well-preserved ancient canal street with traditional architecture, teahouses, and craft shops. Best explored by gondola."},"사자림":{name:"Lion Grove Garden",desc:"A UNESCO World Heritage garden famous for its labyrinthine rockery and pavilions. A masterpiece of classical Chinese garden design."},"수제운하":{name:"Suzhou Ancient Canal",desc:"Part of the Grand Canal UNESCO World Heritage site. Night cruises offer views of illuminated bridges and historic buildings."}}},
ja:{description:"蘇州は東洋のベニスと呼ばれ、2,500年の歴史を持つ庭園文化と美しい水路の都市です。ユネスコに登録された古典庭園群が中国の造園芸術の精髄を見せます。",spots:{"졸정원":{name:"拙政園",desc:"中国最大で最も有名な古典庭園で、ユネスコ世界文化遺産です。季節ごとに異なる風景を楽しめます。"},"호구(虎丘)":{name:"虎丘",desc:"蘇州一の名勝として知られ、傾いた雲岩寺塔と美しい庭園があります。伝説と歴史に富んでいます。"},"평강로":{name:"平江路",desc:"伝統建築、茶館、工芸品店が並ぶよく保存された古い運河通りです。ゴンドラで探索するのが最適です。"},"사자림":{name:"獅子林",desc:"迷路のような奇岩と楼閣で有名なユネスコ世界文化遺産の庭園です。中国古典庭園設計の傑作です。"},"수제운하":{name:"蘇州古運河",desc:"ユネスコ世界遺産の大運河の一部です。夜のクルーズでは照明された橋と歴史的建造物を見られます。"}}},
zh:{description:"苏州被称为东方威尼斯，是拥有2500年历史的园林文化和美丽水道的城市。列入联合国教科文组织的古典园林展现中国园林艺术的精髓。",spots:{"졸정원":{name:"拙政园",desc:"中国最大最著名的古典园林，联合国教科文组织世界文化遗产。四季呈现不同美景。"},"호구(虎丘)":{name:"虎丘",desc:"被誉为苏州第一名胜，有倾斜的云岩寺塔和美丽园林。充满传说和历史。"},"평강로":{name:"平江路",desc:"保存完好的古运河街，传统建筑、茶馆和工艺品店林立。乘坐贡多拉游览最佳。"},"사자림":{name:"狮子林",desc:"以迷宫般的假山石和亭台楼阁闻名的联合国教科文组织世界文化遗产园林。中国古典园林设计的杰作。"},"수제운하":{name:"苏州古运河",desc:"联合国教科文组织世界遗产大运河的一部分。夜游可欣赏灯火辉煌的桥梁和历史建筑。"}}}
},
...
// ── 니스 ──
"니스":{
en:{description:"Nice is the heart of the Côte d'Azur (French Riviera) with beautiful Mediterranean blue seas and glamorous beaches. It's the city of light beloved by artists like Matisse and Chagall.",spots:{"프롬나드 데 장글레":{name:"Promenade des Anglais",desc:"A famous 7km seafront promenade along the azure Mediterranean. Perfect for sunset strolls and people-watching."},"구시가지(비유 니스)":{name:"Vieux Nice",desc:"A charming old town with narrow alleys, colorful buildings, and bustling markets. The Cours Saleya flower market is a must-visit."},"마티스 미술관":{name:"Matisse Museum",desc:"A museum dedicated to Henri Matisse who spent his final years in Nice. Houses his paintings, sculptures, and paper cut-outs."},"성 니콜라스 대성당":{name:"St. Nicholas Orthodox Cathedral",desc:"The largest Orthodox cathedral in Western Europe with stunning Russian architecture and colorful onion domes."},"마르크 샤갈 미술관":{name:"Marc Chagall Museum",desc:"A museum showcasing Chagall's Biblical Message series and stained glass windows. Set in a beautiful garden."}}},
ja:{description:"ニースはコート・ダジュール(フランスのリビエラ)の中心都市で、地中海の青い海と華やかなビーチが魅力的です。マティスやシャガルなど芸術家が愛した光の都市です。",spots:{"프롬나드 데 장글레":{name:"プロムナード・デ・ザングレ",desc:"紺碧の地中海に沿った有名な7kmの海辺の遊歩道です。夕暮れの散歩と人間観察に最適です。"},"구시가지(비유 니스)":{name:"ヴィエイユ・ニース",desc:"狭い路地、カラフルな建物、賑やかな市場がある魅力的な旧市街です。クール・サレヤの花市は必見です。"},"마티스 미술관":{name:"マティス美術館",desc:"ニースで晩年を過ごしたアンリ・マティスの美術館です。彼の絵画、彫刻、切り絵が収蔵されています。"},"성 니콜라스 대성당":{name:"聖ニコラス正教会大聖堂",desc:"西ヨーロッパ最大の正教会大聖堂で、見事なロシア建築とカラフルな玉ねぎドームがあります。"},"마르크 샤갈 미술관":{name:"マルク・シャガール美術館",desc:"シャガールの聖書のメッセージシリーズとステンドグラスを展示する美術館です。美しい庭園に囲まれています。"}}},
zh:{description:"尼斯是蔚蓝海岸（法国里维埃拉）的中心城市，拥有美丽的地中海蓝色大海和迷人的海滩。是马蒂斯、夏加尔等艺术家钟爱的光之城。",spots:{"프롬나드 데 장글레":{name:"英国人漫步大道",desc:"沿湛蓝地中海的著名7公里海滨长廊。日落漫步和观赏人群的理想之地。"},"구시가지(비유 니스)":{name:"尼斯老城",desc:"拥有狭窄小巷、彩色建筑和热闹市场的迷人老城。萨莱雅广场花市是必游之地。"},"마티스 미술관":{name:"马蒂斯博物馆",desc:"专门展示在尼斯度过晚年的亨利·马蒂斯作品的博物馆。收藏了他的绘画、雕塑和剪纸作品。"},"성 니콜라스 대성당":{name:"圣尼古拉东正教大教堂",desc:"西欧最大的东正教大教堂，拥有精美的俄式建筑和彩色洋葱顶。"},"마르크 샤갈 미술관":{name:"马克·夏加尔博物馆",desc:"展示夏加尔《圣经信息》系列和彩色玻璃窗的博物馆。坐落在美丽的花园中。"}}}
},

// ── 리옹 ──
"리옹":{
en:{description:"Lyon is the gastronomic capital of France, birthplace of world-class chefs like Paul Bocuse. It's a UNESCO World Heritage city blending Roman ruins with Renaissance architecture.",spots:{"리옹 구시가지":{name:"Vieux Lyon",desc:"A UNESCO World Heritage old town with narrow Renaissance streets and traboules (secret passageways). The Saint-Jean Cathedral is impressive."},"벨쿠르 광장":{name:"Place Bellecour",desc:"One of Europe's largest squares with a stunning view of Fourvière Basilica. The heart of Lyon where locals gather."},"푸르비에르 언덕":{name:"Fourvière Hill",desc:"A hilltop with a white basilica offering panoramic views of Lyon. Ancient Roman theaters are also located here."},"폴 보퀴즈 시장":{name:"Les Halles de Lyon Paul Bocuse",desc:"A gourmet indoor market named after legendary chef Paul Bocuse. A paradise of cheese, charcuterie, and pastries."},"리옹 벽화":{name:"Mur des Canuts",desc:"Europe's largest trompe-l'œil mural depicting Lyon's silk-weaving history. An impressive optical illusion."}}},
ja:{description:"リヨンはフランス美食の都で、ポール・ボキューズなど世界的なシェフを輩出した場所です。ローマ時代の遺跡とルネサンス建築が調和したユネスコ世界文化遺産の都市です。",spots:{"리옹 구시가지":{name:"ヴィユー・リヨン",desc:"狭いルネサンス通りとトラブール(秘密の通路)があるユネスコ世界文化遺産の旧市街です。サン・ジャン大聖堂が印象的です。"},"벨쿠르 広場":{name:"ベルクール広場",desc:"ヨーロッパ最大級の広場でフルヴィエール大聖堂の素晴らしい眺めがあります。地元の人が集まるリヨンの中心です。"},"푸르비에르 언덕":{name:"フルヴィエールの丘",desc:"白い大聖堂がある丘でリヨンのパノラマビューが楽しめます。古代ローマ劇場もここにあります。"},"폴 보퀴즈 시장":{name:"レ・アール・ド・リヨン・ポール・ボキューズ",desc:"伝説のシェフ、ポール・ボキューズの名を冠した美食の屋内市場です。チーズ、シャルキュトリー、パティスリーの天国です。"},"리옹 벽화":{name:"カニュの壁画",desc:"リヨンの絹織り歴史を描いたヨーロッパ最大のだまし絵壁画です。印象的な視覚トリックです。"}}},
zh:{description:"里昂是法国美食之都，是保罗·博古斯等世界级厨师的诞生地。是罗马遗迹与文艺复兴建筑交融的联合国教科文组织世界文化遗产城市。",spots:{"리옹 구시가지":{name:"里昂老城",desc:"拥有狭窄文艺复兴街道和特拉布勒（秘密通道）的联合国教科文组织世界文化遗产老城。圣让大教堂令人印象深刻。"},"벨쿠르 广场":{name:"白莱果广场",desc:"欧洲最大广场之一，可欣赏富维耶圣母院的壮丽景色。是当地人聚集的里昂中心。"},"푸르비에르 언덕":{name:"富维耶山",desc:"山顶有白色圣母院，可俯瞰里昂全景。古罗马剧场也位于此。"},"폴 보퀴즈 시장":{name:"保罗·博古斯美食市场",desc:"以传奇厨师保罗·博古斯命名的美食室内市场。是奶酪、熟食和糕点的天堂。"},"리옹 벽画":{name:"卡尼壁画",desc:"描绘里昂丝织历史的欧洲最大错视壁画。令人印象深刻的视觉幻象。"}}}
},
