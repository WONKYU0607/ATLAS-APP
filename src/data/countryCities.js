...
export const COUNTRY_CITIES = {
  ...
  "France": [
    ...
    { name:"아비뇽", lat:43.95, lng:4.81, emoji:"🏰", color:"#8e44ad" },
    { name:"카르카손", lat:43.21, lng:2.35, emoji:"🏰", color:"#d35400" },
    { name:"디종", lat:47.32, lng:5.04, emoji:"🍷", color:"#c0392b" },
    { name:"낭트", lat:47.22, lng:-1.55, emoji:"🐘", color:"#16a085" },
    { name:"생말로", lat:48.65, lng:-2.03, emoji:"⛵", color:"#2980b9" },
    { name:"베르사유", lat:48.80, lng:2.13, emoji:"👑", color:"#f1c40f" },
    { name:"릴", lat:50.63, lng:3.07, emoji:"🏛️", color:"#e74c3c" },
    { name:"샤모니", lat:45.92, lng:6.87, emoji:"🏔️", color:"#3498db" },
    { name:"칸", lat:43.55, lng:7.02, emoji:"🎬", color:"#e91e63" },
    { name:"에트르타", lat:49.71, lng:0.21, emoji:"🌊", color:"#27ae60" },
    { name:"루르드", lat:43.10, lng:-0.05, emoji:"🙏", color:"#f39c12" },
  ],
  "Italy": [
    ...
    { name:"시칠리아", lat:38.1157, lng:13.3615, emoji:"🍋", color:"#e67e22" },
    ...
    { name:"베로나", lat:45.44, lng:10.99, emoji:"💘", color:"#e91e63" },
    { name:"토리노", lat:45.07, lng:7.69, emoji:"⛷️", color:"#2980b9" },
    { name:"피사", lat:43.72, lng:10.40, emoji:"🗼", color:"#f39c12" },
    { name:"아시시", lat:43.07, lng:12.61, emoji:"⛪", color:"#d35400" },
    { name:"루카", lat:43.84, lng:10.50, emoji:"🏛️", color:"#27ae60" },
    { name:"코모호수", lat:45.98, lng:9.25, emoji:"🏞️", color:"#3498db" },
    { name:"돌로미티", lat:46.41, lng:11.84, emoji:"🏔️", color:"#95a5a6" },
    { name:"사르데냐", lat:39.2238, lng:9.1217, emoji:"🏖️", color:"#1abc9c" },
    { name:"제노바", lat:44.41, lng:8.93, emoji:"⚓", color:"#34495e" },
  ],
  "Spain": [
    ...
    { name:"코르도바", lat:37.88, lng:-4.78, emoji:"🕌", color:"#d35400" },
    { name:"사라고사", lat:41.66, lng:-0.88, emoji:"🏛️", color:"#3498db" },
    { name:"쿠엥카", lat:40.07, lng:-2.13, emoji:"🏘️", color:"#e67e22" },
    { name:"론다", lat:36.74, lng:-5.16, emoji:"🌉", color:"#c0392b" },
    { name:"카디스", lat:36.52, lng:-6.29, emoji:"⛵", color:"#2980b9" },
    { name:"살라망카", lat:40.97, lng:-5.66, emoji:"📚", color:"#f39c12" },
    { name:"세고비아", lat:40.95, lng:-4.12, emoji:"🏰", color:"#e74c3c" },
    { name:"팔마", lat:39.57, lng:2.65, emoji:"🏖️", color:"#1abc9c" },
    { name:"이비자", lat:38.91, lng:1.44, emoji:"🎉", color:"#e91e63" },
    { name:"테네리페", lat:28.4636, lng:-16.2518, emoji:"🌋", color:"#16a085" },
  ],
  "Germany": [
    ...
    { name:"뉘른베르크", lat:49.45, lng:11.08, emoji:"🏯", color:"#8e44ad" },
    { name:"포츠담", lat:52.40, lng:13.06, emoji:"👑", color:"#2980b9" },
    { name:"라이프치히", lat:51.34, lng:12.38, emoji:"🎶", color:"#e91e63" },
    { name:"바덴바덴", lat:48.76, lng:8.24, emoji:"♨️", color:"#d35400" },
    { name:"밤베르크", lat:49.89, lng:10.90, emoji:"🍺", color:"#f39c12" },
    { name:"뤼벡", lat:53.87, lng:10.69, emoji:"🏛️", color:"#27ae60" },
    { name:"뷔르츠부르크", lat:49.79, lng:9.93, emoji:"🍷", color:"#e74c3c" },
    { name:"슈투트가르트", lat:48.78, lng:9.18, emoji:"🚗", color:"#2ecc71" },
    { name:"트리어", lat:49.75, lng:6.64, emoji:"🏛️", color:"#34495e" },
    { name:"아헨", lat:50.78, lng:6.08, emoji:"⛪", color:"#1abc9c" },
    { name:"레겐스부르크", lat:49.02, lng:12.10, emoji:"🏰", color:"#9b59b6" },
  ],
  "United Kingdom": [
    ...
    { name:"브라이튼", lat:50.82, lng:-0.14, emoji:"🌊", color:"#e91e63" },
    { name:"스톤헨지", lat:51.18, lng:-1.83, emoji:"🗿", color:"#7f8c8d" },
    { name:"레이크디스트릭트", lat:54.47, lng:-3.09, emoji:"🏞️", color:"#1abc9c" },
    { name:"벨파스트", lat:54.60, lng:-5.93, emoji:"🚢", color:"#c0392b" },
    { name:"카디프", lat:51.48, lng:-3.18, emoji:"🏴󠁧󠁢󠁷󠁬󠁳󠁿", color:"#d35400" },
    { name:"인버네스", lat:57.48, lng:-4.22, emoji:"🦕", color:"#34495e" },
    { name:"더럼", lat:54.78, lng:-1.57, emoji:"⛪", color:"#8e44ad" },
    { name:"캔터베리", lat:51.28, lng:1.08, emoji:"⛪", color:"#f39c12" },
    { name:"윈저", lat:51.48, lng:-0.61, emoji:"👑", color:"#e74c3c" },
    { name:"스카이섬", lat:57.27, lng:-6.22, emoji:"🏔️", color:"#16a085" },
  ],
  ...
  "Thailand": [
    ...
    { name:"푸켓", lat:7.8965, lng:98.2960, emoji:"🏖️", color:"#3498db" },
  ...
  "Greece": [
    ...
    { name:"크레타", lat:35.3387, lng:25.1442, emoji:"🌿", color:"#2ecc71" },
  ...
  "Vietnam": [
    ...
    { name:"푸꾸옥", lat:10.2170, lng:103.9595, emoji:"🏝️", color:"#16a085" },
  ...
  "Indonesia": [
    { name:"발리", lat:-8.7180, lng:115.1686, emoji:"🌴", color:"#2ecc71" },
  ...
  "Philippines": [
    ...
    { name:"팔라완", lat:9.7392, lng:118.7353, emoji:"🏝️", color:"#3498db" },
  ...
  "Portugal": [
    ...
    { name:"마데이라", lat:32.6669, lng:-16.9241, emoji:"🌺", color:"#8e44ad" },
  ],
  "Netherlands": [
  ...
  "Canada": [
    ...
    { name:"캘거리", lat:51.04, lng:-114.07, emoji:"🤠", color:"#e74c3c" },
    { name:"에드먼턴", lat:53.55, lng:-113.49, emoji:"🛢️", color:"#d35400" },
    { name:"위니펙", lat:49.90, lng:-97.14, emoji:"🐻‍❄️", color:"#2980b9" },
    { name:"핼리팩스", lat:44.65, lng:-63.58, emoji:"⚓", color:"#8e44ad" },
    { name:"재스퍼", lat:52.87, lng:-118.08, emoji:"🏔️", color:"#16a085" },
    { name:"휘슬러", lat:50.12, lng:-122.95, emoji:"⛷️", color:"#e91e63" },
    { name:"프린스에드워드섬", lat:46.25, lng:-63.13, emoji:"🏝️", color:"#f39c12" },
    { name:"머스코카", lat:44.94, lng:-79.30, emoji:"🏞️", color:"#1abc9c" },
    { name:"화이트호스", lat:60.72, lng:-135.05, emoji:"🐻", color:"#34495e" },
    { name:"토피노", lat:49.15, lng:-125.91, emoji:"🌊", color:"#3498db" },
    { name:"루이스호수", lat:51.42, lng:-116.22, emoji:"🏞️", color:"#9b59b6" },
    { name:"처칠", lat:58.77, lng:-94.17, emoji:"🐻‍❄️", color:"#2c3e50" },
  ],
  "Cuba": [
