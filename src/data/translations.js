...
export const T = {
  ...
  courseChangeDay:{ko:'날짜 변경',en:'Change day',ja:'日付変更',zh:'更改日期'},
  courseGoCity:{ko:'도시로 이동',en:'Go to city',ja:'都市へ',zh:'前往城市'},
  courseGoMap:{ko:'지도에서 보기',en:'View on map',ja:'地図で見る',zh:'在地图查看'},
  ...
  feedTabFollowing:{ko:'팔로잉',en:'Following',ja:'フォロー中',zh:'关注'},
  feedTabMine:{ko:'내 글',en:'Mine',ja:'自分',zh:'我的'},
  feedEmpty:{ko:'아직 여행기가 없습니다',en:'No journals yet',ja:'まだ旅行記がありません',zh:'还没有游记'},
  feedEmptyHint:{ko:'첫 번째 여행기를 작성해보세요!',en:'Write the first journal!',ja:'最初の旅行記を書いてみましょう！',zh:'写下第一篇游记吧！'},
  // ── 여행기 작성 ──
  journalNew:{ko:'새 여행기',en:'New Journal',ja:'新しい旅行記',zh:'新游记'},
  journalEdit:{ko:'여행기 수정',en:'Edit Journal',ja:'旅行記を編集',zh:'编辑游记'},
  journalTitle:{ko:'제목',en:'Title',ja:'タイトル',zh:'标题'},
  journalTitlePh:{ko:'예: 도쿄 첫 여행',en:'e.g. My first trip to Tokyo',ja:'例：初めての東京旅行',zh:'例如：东京初次旅行'},
  journalCities:{ko:'방문 도시',en:'Cities',ja:'訪問都市',zh:'访问城市'},
  journalCityAdd:{ko:'+ 도시 추가',en:'+ Add city',ja:'+ 都市を追加',zh:'+ 添加城市'},
  journalDays:{ko:'일정',en:'Duration',ja:'日程',zh:'行程天数'},
  journalRating:{ko:'별점',en:'Rating',ja:'評価',zh:'评分'},
  journalPhotos:{ko:'사진 (최대 10장)',en:'Photos (max 10)',ja:'写真（最大10枚）',zh:'照片（最多10张）'},
  journalBody:{ko:'본문',en:'Body',ja:'本文',zh:'内容'},
  journalBodyPh:{ko:'여행 이야기를 자유롭게 적어주세요...',en:'Share your travel story...',ja:'旅行の話を自由に書いてください...',zh:'自由分享您的旅行故事...'},
  journalVisibility:{ko:'공개 범위',en:'Visibility',ja:'公開範囲',zh:'可见范围'},
  visPublic:{ko:'전체 공개',en:'Public',ja:'全体公開',zh:'公开'},
  visPrivate:{ko:'비공개',en:'Private',ja:'非公開',zh:'私密'},
  journalSave:{ko:'저장',en:'Save',ja:'保存',zh:'保存'},
  journalSaved:{ko:'✅ 여행기가 저장되었습니다!',en:'✅ Journal saved!',ja:'✅ 旅行記を保存しました！',zh:'✅ 游记已保存！'},
  journalDelete:{ko:'삭제',en:'Delete',ja:'削除',zh:'删除'},
  journalDeleteConfirm:{ko:'이 여행기를 삭제하시겠습니까?',en:'Delete this journal?',ja:'この旅行記を削除しますか？',zh:'要删除此游记吗？'},
  journalLike:{ko:'좋아요',en:'Like',ja:'いいね',zh:'点赞'},
  journalAuthorMe:{ko:'나',en:'Me',ja:'自分',zh:'我'},
  journalNoTitle:{ko:'(제목 없음)',en:'(No title)',ja:'（無題）',zh:'（无标题）'},
  journalSelectCity:{ko:'도시 선택',en:'Select city',ja:'都市を選択',zh:'选择城市'},
  journalRequiredTitle:{ko:'제목을 입력해주세요',en:'Please enter a title',ja:'タイトルを入力してください',zh:'请输入标题'},
...
// 일본
"도쿄":["Tokyo","東京","东京"],"교토":["Kyoto","京都","京都"],"오사카":["Osaka","大阪","大阪"],"삿포로":["Sapporo","札幌","札幌"],"나라":["Nara","奈良","奈良"],"나고야":["Nagoya","名古屋","名古屋"],"후쿠오카":["Fukuoka","福岡","福冈"],"히로시마":["Hiroshima","広島","广岛"],"고베":["Kobe","神戸","神户"],"오키나와":["Okinawa","沖縄","冲绳"],"가나자와":["Kanazawa","金沢","金泽"],"하코네":["Hakone","箱根","箱根"],"다카마쓰":["Takamatsu","高松","高松"],"마쓰야마":["Matsuyama","松山","松山"],"시즈오카":["Shizuoka","静岡","静冈"],"하코다테":["Hakodate","函館","函馆"],"돗토리":["Tottori","鳥取","鸟取"],"미야자키":["Miyazaki","宮崎","宫崎"],
// 중국
...
// 싱가포르·캄보디아·미얀마
"싱가포르":["Singapore","シンガポール","新加坡"],"시엠립":["Siem Reap","シェムリアップ","暹粒"],"프놈펜":["Phnom Penh","プノンペン","金边"],"시아누크빌":["Sihanoukville","シアヌークビル","西哈努克"],"양곤":["Yangon","ヤンゴン","仰光"],"바간":["Bagan","バガン","蒲甘"],"만달레이":["Mandalay","マンダレー","曼德勒"],"인레호수":["Inle Lake","インレー湖","茵莱湖"],
// 네팔·스리랑카·필리핀
...
// 추가 81개 도시 핀 라벨 (한국 7 + 일본 8 + 중국 8 + 태국 12 + 인도 10 + 베트남 11 + 소국 25)
"대전":["Daejeon","大田","大田"],"울산":["Ulsan","蔚山","蔚山"],"포항":["Pohang","浦項","浦项"],"창원":["Changwon","昌原","昌原"],"안동":["Andong","安東","安东"],"목포":["Mokpo","木浦","木浦"],"공주":["Gongju","公州","公州"],
"요코하마":["Yokohama","横浜","横滨"],"닛코":["Nikko","日光","日光"],"가마쿠라":["Kamakura","鎌倉","镰仓"],"다카야마":["Takayama","高山","高山"],"나가사키":["Nagasaki","長崎","长崎"],"구마모토":["Kumamoto","熊本","熊本"],"벳푸":["Beppu","別府","别府"],"센다이":["Sendai","仙台","仙台"],
"광저우":["Guangzhou","広州","广州"],"선전":["Shenzhen","深圳","深圳"],"충칭":["Chongqing","重慶","重庆"],"우한":["Wuhan","武漢","武汉"],"칭다오":["Qingdao","青島","青岛"],"다롄":["Dalian","大連","大连"],"하얼빈":["Harbin","ハルビン","哈尔滨"],"톈진":["Tianjin","天津","天津"],
"수코타이":["Sukhothai","スコータイ","素可泰"],"깐차나부리":["Kanchanaburi","カンチャナブリー","北碧"],"후아힌":["Hua Hin","ホアヒン","华欣"],"코타오":["Ko Tao","タオ島","龟岛"],"코팡안":["Ko Pha-ngan","パンガン島","帕岸岛"],"코창":["Ko Chang","チャーン島","象岛"],"코란타":["Ko Lanta","ランタ島","兰塔岛"],"람빵":["Lampang","ラムパーン","南邦"],"핏사눌로크":["Phitsanulok","ピッサヌローク","彭世洛"],"부리람":["Buriram","ブリーラム","武里南"],"매홍손":["Mae Hong Son","メーホンソン","湄宏顺"],
"벵갈루루":["Bengaluru","ベンガルール","班加罗尔"],"첸나이":["Chennai","チェンナイ","金奈"],"하이데라바드":["Hyderabad","ハイデラバード","海得拉巴"],"다르질링":["Darjeeling","ダージリン","大吉岭"],"시믈라":["Shimla","シムラー","西姆拉"],"리시케시":["Rishikesh","リシケシュ","瑞诗凯诗"],"함피":["Hampi","ハンピ","汉皮"],"조드푸르":["Jodhpur","ジョードプル","焦特布尔"],"푸시카르":["Pushkar","プシュカル","普什卡"],"다람살라":["Dharamshala","ダラムサラ","达兰萨拉"],
"달랏":["Da Lat","ダラット","大叻"],"판티엣":["Phan Thiet","ファンティエット","潘切"],"무이네":["Mui Ne","ムイネー","美奈"],"꼰다오":["Con Dao","コンダオ","昆岛"],"하이퐁":["Hai Phong","ハイフォン","海防"],"깐터":["Can Tho","カントー","芹苴"],"동호이":["Dong Hoi","ドンホイ","洞海"],"붕따우":["Vung Tau","ブンタウ","头顿"],"반메투옷":["Buon Ma Thuot","ブオンマトート","邦美蜀"],"꾸이년":["Quy Nhon","クイニョン","归仁"],
"갈웨이":["Galway","ゴールウェイ","戈尔韦"],"안도라라벨랴":["Andorra la Vella","アンドラ・ラ・ベリャ","安道尔城"],"세인트존스":["Saint John's","セントジョンズ","圣约翰"],"나소":["Nassau","ナッソー","拿骚"],"브리지타운":["Bridgetown","ブリッジタウン","布里奇敦"],"로조":["Roseau","ロゾー","罗索"],"세인트조지스":["Saint George's","セントジョージズ","圣乔治"],"타라와":["Tarawa","タラワ","塔拉瓦"],"파두츠":["Vaduz","ファドゥーツ","瓦杜兹"],"발레타":["Valletta","バレッタ","瓦莱塔"],"마주로":["Majuro","マジュロ","马朱罗"],"팔리키르":["Palikir","パリキール","帕利基尔"],"모나코":["Monaco","モナコ","摩纳哥"],"야렌":["Yaren","ヤレン","亚伦"],"응에룰무드":["Ngerulmud","ンゲルルムッド","恩吉鲁穆德"],"라말라":["Ramallah","ラマッラー","拉姆安拉"],"바스테르":["Basseterre","バセテール","巴斯特尔"],"캐스트리스":["Castries","カストリーズ","卡斯特里"],"킹스타운":["Kingstown","キングスタウン","金斯敦"],"아피아":["Apia","アピア","阿皮亚"],"산마리노":["San Marino","サンマリノ","圣马力诺"],"상투메":["São Tomé","サントメ","圣多美"],"호니아라":["Honiara","ホニアラ","霍尼亚拉"],"누쿠알로파":["Nuku'alofa","ヌクアロファ","努库阿洛法"],"푸나푸티":["Funafuti","フナフティ","富纳富提"],"포트빌라":["Port Vila","ポートビラ","维拉港"],"바티칸시티":["Vatican City","バチカン","梵蒂冈"],
// 추가 63개: 유럽·미주 주요국 도시 (France11, Italy9, UK10, Germany11, Spain10, Canada12)
"아비뇽":["Avignon","アヴィニョン","阿维尼翁"],"카르카손":["Carcassonne","カルカソンヌ","卡尔卡松"],"디종":["Dijon","ディジョン","第戎"],"낭트":["Nantes","ナント","南特"],"생말로":["Saint-Malo","サン・マロ","圣马洛"],"베르사유":["Versailles","ヴェルサイユ","凡尔赛"],"릴":["Lille","リール","里尔"],"샤모니":["Chamonix","シャモニー","霞慕尼"],"칸":["Cannes","カンヌ","戛纳"],"에트르타":["Étretat","エトルタ","埃特勒塔"],"루르드":["Lourdes","ルルド","卢尔德"],
"베로나":["Verona","ヴェローナ","维罗纳"],"토리노":["Turin","トリノ","都灵"],"피사":["Pisa","ピサ","比萨"],"아시시":["Assisi","アッシジ","阿西西"],"루카":["Lucca","ルッカ","卢卡"],"코모호수":["Lake Como","コモ湖","科莫湖"],"돌로미티":["Dolomites","ドロミーティ","多洛米蒂"],"사르데냐":["Sardinia","サルデーニャ","撒丁岛"],"제노바":["Genoa","ジェノヴァ","热那亚"],
"브라이튼":["Brighton","ブライトン","布莱顿"],"스톤헨지":["Stonehenge","ストーンヘンジ","巨石阵"],"레이크디스트릭트":["Lake District","湖水地方","湖区"],"벨파스트":["Belfast","ベルファスト","贝尔法斯特"],"카디프":["Cardiff","カーディフ","加的夫"],"인버네스":["Inverness","インヴァネス","因弗内斯"],"더럼":["Durham","ダラム","达勒姆"],"캔터베리":["Canterbury","カンタベリー","坎特伯雷"],"윈저":["Windsor","ウィンザー","温莎"],"스카이섬":["Isle of Skye","スカイ島","斯凯岛"],
"뉘른베르크":["Nuremberg","ニュルンベルク","纽伦堡"],"포츠담":["Potsdam","ポツダム","波茨坦"],"라이프치히":["Leipzig","ライプツィヒ","莱比锡"],"바덴바덴":["Baden-Baden","バーデン・バーデン","巴登-巴登"],"밤베르크":["Bamberg","バンベルク","班贝格"],"뤼벡":["Lübeck","リューベック","吕贝克"],"뷔르츠부르크":["Würzburg","ヴュルツブルク","维尔茨堡"],"슈투트가르트":["Stuttgart","シュトゥットガルト","斯图加特"],"트리어":["Trier","トリーア","特里尔"],"아헨":["Aachen","アーヘン","亚琛"],"레겐스부르크":["Regensburg","レーゲンスブルク","雷根斯堡"],
"코르도바":["Córdoba","コルドバ","科尔多瓦"],"사라고사":["Zaragoza","サラゴサ","萨拉戈萨"],"쿠엥카":["Cuenca","クエンカ","昆卡"],"론다":["Ronda","ロンダ","龙达"],"카디스":["Cádiz","カディス","加的斯"],"살라망카":["Salamanca","サラマンカ","萨拉曼卡"],"세고비아":["Segovia","セゴビア","塞哥维亚"],"팔마":["Palma","パルマ","帕尔马"],"이비자":["Ibiza","イビサ","伊维萨"],"테네리페":["Tenerife","テネリフェ","特内里费"],
"캘거리":["Calgary","カルガリー","卡尔加里"],"에드먼턴":["Edmonton","エドモントン","埃德蒙顿"],"위니펙":["Winnipeg","ウィニペグ","温尼伯"],"핼리팩스":["Halifax","ハリファックス","哈利法克斯"],"재스퍼":["Jasper","ジャスパー","贾斯珀"],"휘슬러":["Whistler","ウィスラー","惠斯勒"],"프린스에드워드섬":["Prince Edward Island","プリンスエドワード島","爱德华王子岛"],"머스코카":["Muskoka","マスコーカ","马斯科卡"],"화이트호스":["Whitehorse","ホワイトホース","白马市"],"토피노":["Tofino","トフィーノ","托菲诺"],"루이스호수":["Lake Louise","ルイーズ湖","路易斯湖"],"처칠":["Churchill","チャーチル","丘吉尔"],
}
