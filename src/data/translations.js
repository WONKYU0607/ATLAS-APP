...
// 멕시코·콜롬비아·페루·칠레
"멕시코시티":["Mexico City","メキシコシティ","墨西哥城"],"칸쿤":["Cancún","カンクン","坎昆"],"과달라하라":["Guadalajara","グアダラハラ","瓜达拉哈拉"],"오악사카":["Oaxaca","オアハカ","瓦哈卡"],"툴룸":["Tulum","トゥルム","图卢姆"],"과나후아토":["Guanajuato","グアナフアト","瓜纳华托"],"치첸이트사":["Chichén Itzá","チチェン・イッツァ","奇琴伊察","Chichen Itza","Tinum","Tinúm","Valladolid","바야돌리드"],"보고타":["Bogotá","ボゴタ","波哥大"],"카르타헤나":["Cartagena","カルタヘナ","卡塔赫纳"],"메데인":["Medellín","メデジン","麦德林"],"살렌토":["Salento","サレント","萨伦托"],"마추픽추":["Machu Picchu","マチュ・ピチュ","马丘比丘","Machupicchu","Aguas Calientes","아구아스칼리엔테스"],"쿠스코":["Cusco","クスコ","库斯科"],"리마":["Lima","リマ","利马"],"나스카":["Nazca","ナスカ","纳斯卡"],"티티카카호수":["Lake Titicaca","チチカカ湖","的的喀喀湖"],"아레키파":["Arequipa","アレキパ","阿雷基帕"],"산티아고":["Santiago","サンティアゴ","圣地亚哥"],"발파라이소":["Valparaíso","バルパライソ","瓦尔帕莱索"],"아타카마":["Atacama","アタカマ","阿塔卡马"],"토레스델파이네":["Torres del Paine","トレス・デル・パイネ","百内"],"이스터섬":["Easter Island","イースター島","复活节岛"],
// 뉴질랜드
