...
export const T = {
  ...
  search:{ko:'도시, 국가 검색…',en:'Search city, country…',ja:'都市・国を検索…',zh:'搜索城市、国家…'},
...
// 도시명 다국어 [en, ja, zh]
export const CITY_I18N = {"그랜드캐니언빌리지":["Grand Canyon Village"],"웨스트옐로스톤":["West Yellowstone"],"율라라":["Yulara"],"바야돌리드":["Valladolid"],"아구아스칼리엔테스":["Aguas Calientes"],"마겔랑":["Magelang"],"셀추크":["Selcuk"],"와디무사":["Wadi Musa"],"칼람바카":["Kalambaka"],"그린다비크":["Grindavik"],"회픈":["Hofn"],"셀포스":["Selfoss"],"테아나우":["Te Anau"],"마타마타":["Matamata"],"푸에르토나탈레스":["Puerto Natales"],"넬스프루이트":["Nelspruit"],"모시":["Moshi"],"자블랴크":["Zabljak"],"메켈레":["Mekele"],"아라드":["Arad"],"나록":["Narok"],"코모":["Como"],"이르쿠츠크":["Irkutsk"],"냐웅쉐":["Nyaungshwe"],"하트갈":["Khatgal"],"푸에르토이과수":["Puerto Iguazu"],"라포르투나":["La Fortuna"],"산페드로데아타카마":["San Pedro de Atacama"],"엘칼라파테":["El Calafate"],"코르티나담페초":["Cortina d'Ampezzo"],"코치":["Kochi"],"푸에르토아요라":["Puerto Ayora"],"하르호린":["Kharkhorin"],"말레":["Male"],
// === 신규 추가 도시 327개 ===
"휴스턴":["Houston","ヒューストン","休斯顿"],"애틀랜타":["Atlanta","アトランタ","亚特兰大"],"미니애폴리스":["Minneapolis","ミネアポリス","明尼阿波利斯"],"캔자스시티":["Kansas City","カンザスシティ","堪萨斯城"],"필라델피아":["Philadelphia","フィラデルフィア","费城"],"댈러스":["Dallas","ダラス","达拉斯"],"샌안토니오":["San Antonio","サンアントニオ","圣安东尼奥"],"오스틴":["Austin","オースティン","奥斯汀"],"솔트레이크시티":["Salt Lake City","ソルトレイクシティ","盐湖城"],"사바나":["Savannah","サバンナ","萨凡纳"],"세인트루이스":["St. Louis","セントルイス","圣路易斯"],"멤피스":["Memphis","メンフィス","孟菲斯"],"피츠버그":["Pittsburgh","ピッツバーグ","匹兹堡"],"신시내티":["Cincinnati","シンシナティ","辛辛那提"],"디트로이트":["Detroit","デトロイト","底特律"],"샬럿":["Charlotte","シャーロット","夏洛特"],"새크라멘토":["Sacramento","サクラメント","萨克拉门托"],"앵커리지":["Anchorage","アンカレッジ","安克雷奇"],"키웨스트":["Key West","キーウェスト","基韦斯特"],"산타페":["Santa Fe","サンタフェ","圣菲"],"가루이자와":["Karuizawa","軽井沢","轻井泽"],"오타루":["Otaru","小樽","小樽"],"후라노":["Furano","富良野","富良野"],"니세코":["Niseko","ニセコ","二世古"],"노보리베쓰":["Noboribetsu","登別","登别"],"아오모리":["Aomori","青森","青森"],"모리오카":["Morioka","盛岡","盛冈"],"야마가타":["Yamagata","山形","山形"],"가고시마":["Kagoshima","鹿児島","鹿儿岛"],"이부스키":["Ibusuki","指宿","指宿"],"나하":["Naha","那覇","那霸"],"이시가키":["Ishigaki","石垣","石垣"],"미야코지마":["Miyakojima","宮古島","宫古岛"],"가와고에":["Kawagoe","川越","川越"],"콜마르":["Colmar","コルマール","科尔马"],"님":["Nîmes","ニーム","尼姆"],"엑상프로방스":["Aix-en-Provence","エクス・アン・プロヴァンス","普罗旺斯艾克斯"],"비아리츠":["Biarritz","ビアリッツ","比亚里茨"],"루앙":["Rouen","ルーアン","鲁昂"],"렌":["Rennes","レンヌ","雷恩"],"투르":["Tours","トゥール","图尔"],"클레르몽페랑":["Clermont-Ferrand","クレルモン・フェラン","克莱蒙费朗"],"그르노블":["Grenoble","グルノーブル","格勒诺布尔"],"페르피냥":["Perpignan","ペルピニャン","佩皮尼昂"],"몽펠리에":["Montpellier","モンペリエ","蒙彼利埃"],"라로셸":["La Rochelle","ラ・ロシェル","拉罗谢尔"],"오를레앙":["Orléans","オルレアン","奥尔良"],"아작시오":["Ajaccio","アジャクシオ","阿雅克肖"],"도빌":["Deauville","ドーヴィル","多维尔"],"히로나":["Girona","ジローナ","赫罗纳"],"오비에도":["Oviedo","オビエド","奥维耶多"],"카세레스":["Cáceres","カセレス","卡塞雷斯"],"라코루냐":["A Coruña","ア・コルーニャ","拉科鲁尼亚"],"메리다":["Mérida","メリダ","梅里达"],"메리다(스페인)":["Mérida","メリダ","梅里达"],"부르고스":["Burgos","ブルゴス","布尔戈斯"],"레온":["León","レオン","莱昂"],"팜플로나":["Pamplona","パンプローナ","潘普洛纳"],"알리칸테":["Alicante","アリカンテ","阿利坎特"],"무르시아":["Murcia","ムルシア","穆尔西亚"],"히혼":["Gijón","ヒホン","希洪"],"산탄데르":["Santander","サンタンデール","桑坦德"],"라스팔마스":["Las Palmas","ラスパルマス","拉斯帕尔马斯"],"로그로뇨":["Logroño","ログローニョ","洛格罗尼奥"],"바리":["Bari","バーリ","巴里"],"트리에스테":["Trieste","トリエステ","的里雅斯特"],"파도바":["Padua","パドヴァ","帕多瓦"],"페루자":["Perugia","ペルージャ","佩鲁贾"],"라벨로":["Ravello","ラヴェッロ","拉韦洛"],"레체":["Lecce","レッチェ","莱切"],"마테라":["Matera","マテーラ","马泰拉"],"파르마":["Parma","パルマ","帕尔马"],"라벤나":["Ravenna","ラヴェンナ","拉文纳"],"우르비노":["Urbino","ウルビーノ","乌尔比诺"],"베르가모":["Bergamo","ベルガモ","贝加莫"],"만토바":["Mantua","マントヴァ","曼托瓦"],"트렌토":["Trento","トレント","特伦托"],"카프리":["Capri","カプリ","卡普里"],"타오르미나":["Taormina","タオルミーナ","陶尔米纳"],"리즈":["Leeds","リーズ","利兹"],"뉴캐슬":["Newcastle","ニューカッスル","纽卡斯尔"],"글로스터":["Gloucester","グロスター","格洛斯特"],"셰필드":["Sheffield","シェフィールド","谢菲尔德"],"애버딘":["Aberdeen","アバディーン","阿伯丁"],"노팅엄":["Nottingham","ノッティンガム","诺丁汉"],"브리스톨":["Bristol","ブリストル","布里斯托尔"],"더비":["Derby","ダービー","德比"],"엑서터":["Exeter","エクセター","埃克塞特"],"플리머스":["Plymouth","プリマス","普利茅斯"],"윈체스터":["Winchester","ウィンチェスター","温彻斯特"],"솔즈베리":["Salisbury","ソールズベリー","索尔兹伯里"],"세인트앤드루스":["St Andrews","セント・アンドルーズ","圣安德鲁斯"],"스털링":["Stirling","スターリング","斯特灵"],"포츠머스":["Portsmouth","ポーツマス","朴茨茅斯"],"해밀턴":["Hamilton","ハミルトン","汉密尔顿"],"키치너":["Kitchener","キッチナー","基奇纳"],"켈로나":["Kelowna","ケロウナ","基洛纳"],"사스카툰":["Saskatoon","サスカトゥーン","萨斯卡通"],"레지나":["Regina","レジャイナ","里贾纳"],"프레더릭턴":["Fredericton","フレデリクトン","弗雷德里克顿"],"샬럿타운":["Charlottetown","シャーロットタウン","夏洛特敦"],"옐로나이프":["Yellowknife","イエローナイフ","耶洛奈夫"],"캔모어":["Canmore","キャンモア","坎莫尔"],"나나이모":["Nanaimo","ナナイモ","纳奈莫"],"셔브룩":["Sherbrooke","シャーブルック","舍布鲁克"],"선더베이":["Thunder Bay","サンダーベイ","桑德贝"],"무스조":["Moose Jaw","ムースジョー","穆斯乔"],"콘스탄츠":["Konstanz","コンスタンツ","康斯坦茨"],"마인츠":["Mainz","マインツ","美因茨"],"에르푸르트":["Erfurt","エアフルト","埃尔福特"],"슈베린":["Schwerin","シュヴェリーン","什未林"],"키일":["Kiel","キール","基尔"],"핑야오":["Pingyao","平遥","平遥"],"다리":["Dali","大理","大理"],"핫야이":["Hat Yai","ハジャイ","合艾"],"코사멧":["Ko Samet","サメット島","沙美岛"],"우돈타니":["Udon Thani","ウドンタニ","乌隆他尼"],"나콘랏차시마":["Nakhon Ratchasima","ナコンラチャシマ","呵叻"],"코리뻬":["Ko Lipe","リペ島","丽贝岛"],"미토":["My Tho","ミトー","美荻"],"빈롱":["Vinh Long","ヴィンロン","永隆"],"마이소르":["Mysore","マイソール","迈索尔"],"아우랑가바드":["Aurangabad","アウランガーバード","奥兰加巴德"],"파루":["Faro","ファロ","法鲁"],"브라가":["Braga","ブラガ","布拉加"],"에보라":["Évora","エヴォラ","埃武拉"],"아베이루":["Aveiro","アヴェイロ","阿威罗"],"기마랑이스":["Guimarães","ギマランイス","吉马良斯"],"카스카이스":["Cascais","カスカイス","卡斯凯什"],"라구스":["Lagos","ラゴス","拉古斯"],"빌라노바드가이아":["Vila Nova de Gaia","ヴィラ・ノヴァ・デ・ガイア","新城"],"나자레":["Nazaré","ナザレ","纳扎雷"],"테살로니키":["Thessaloniki","テッサロニキ","塞萨洛尼基"],"나프플리오":["Nafplio","ナフプリオ","纳夫普利翁"],"자킨토스":["Zakynthos","ザキントス","扎金索斯"],"파로스":["Paros","パロス島","帕罗斯"],"낙소스":["Naxos","ナクソス島","纳克索斯"],"델포이":["Delphi","デルフィ","德尔斐"],"이즈미르":["Izmir","イズミル","伊兹密尔"],"앙카라":["Ankara","アンカラ","安卡拉"],"페티예":["Fethiye","フェティエ","费特希耶"],"마르마리스":["Marmaris","マルマリス","马尔马里斯"],"부르사":["Bursa","ブルサ","布尔萨"],"사프란볼루":["Safranbolu","サフランボル","番红花城"],"플라야델카르멘":["Playa del Carmen","プラヤ・デル・カルメン","卡门海滩"],"푸에르토바야르타":["Puerto Vallarta","プエルト・バジャルタ","巴亚尔塔港"],"산크리스토발":["San Cristóbal","サン・クリストバル","圣克里斯托瓦尔"],"몬테레이":["Monterrey","モンテレイ","蒙特雷"],"푸에블라":["Puebla","プエブラ","普埃布拉"],"우붓":["Ubud","ウブド","乌布"],"수라바야":["Surabaya","スラバヤ","泗水"],"반둥":["Bandung","バンドン","万隆"],"길리":["Gili Islands","ギリ島","吉利岛"],"브로모":["Bromo","ブロモ山","布罗莫"],"메단":["Medan","メダン","棉兰"],"애들레이드":["Adelaide","アデレード","阿德莱德"],"캔버라":["Canberra","キャンベラ","堪培拉"],"다윈":["Darwin","ダーウィン","达尔文"],"바이런베이":["Byron Bay","バイロンベイ","拜伦湾"],"그린델발트":["Grindelwald","グリンデルワルト","格林德瓦"],"라우터브룬넨":["Lauterbrunnen","ラウターブルンネン","劳特布龙嫩"],"몽트뢰":["Montreux","モントルー","蒙特勒"],"바젤":["Basel","バーゼル","巴塞尔"],"로잔":["Lausanne","ローザンヌ","洛桑"],"생모리츠":["St. Moritz","サンモリッツ","圣莫里茨"],"잔세스칸스":["Zaanse Schans","ザーンセ・スカンス","桑斯安斯"],"히트호른":["Giethoorn","ヒートホールン","羊角村"],"델프트":["Delft","デルフト","代尔夫特"],"하를럼":["Haarlem","ハールレム","哈勒姆"],"에인트호번":["Eindhoven","アイントホーフェン","埃因霍温"],"흐로닝언":["Groningen","フローニンゲン","格罗宁根"],"네이메헌":["Nijmegen","ナイメーヘン","奈梅亨"],"쿠트나호라":["Kutná Hora","クトナー・ホラ","库特纳霍拉"],"올로모우츠":["Olomouc","オロモウツ","奥洛穆茨"],"피세크":["Písek","ピーセク","皮塞克"],"텔치":["Telč","テルチ","特尔奇"],"리베레츠":["Liberec","リベレツ","利贝雷茨"],"플젠":["Plzeň","プルゼニ","比尔森"],"체스케부데요비체":["České Budějovice","チェスケー・ブデヨヴィツェ","捷克布杰约维采"],"미쿨로프":["Mikulov","ミクロフ","米库洛夫"],"바트이슐":["Bad Ischl","バート・イシュル","巴特伊舍尔"],"클라겐푸르트":["Klagenfurt","クラーゲンフルト","克拉根福"],"린츠":["Linz","リンツ","林茨"],"브레겐츠":["Bregenz","ブレゲンツ","布雷根茨"],"장크트볼프강":["St. Wolfgang","ザンクト・ヴォルフガング","圣沃尔夫冈"],"멜크":["Melk","メルク","梅尔克"],"빌라흐":["Villach","フィラッハ","菲拉赫"],"자다르":["Zadar","ザダル","扎达尔"],"로빈":["Rovinj","ロヴィニ","罗维尼"],"풀라":["Pula","プーラ","普拉"],"시베니크":["Šibenik","シベニク","希贝尼克"],"트로기르":["Trogir","トロギル","特罗吉尔"],"오파티야":["Opatija","オパティヤ","奥帕蒂亚"],"모토분":["Motovun","モトヴン","莫托文"],"단수이":["Tamsui","淡水","淡水"],"컨딩":["Kenting","墾丁","垦丁"],"르웨탄":["Sun Moon Lake","日月潭","日月潭"],"아리산":["Alishan","阿里山","阿里山"],"진먼":["Kinmen","金門","金门"],"이포":["Ipoh","イポー","怡保"],"쿠칭":["Kuching","クチン","古晋"],"조호바루":["Johor Bahru","ジョホールバル","新山"],"카메론하일랜드":["Cameron Highlands","キャメロンハイランド","金马仑高原"],"티오만":["Tioman","ティオマン島","刁曼岛"],"페르헨티안":["Perhentian Islands","プルヘンティアン島","停泊岛"],"미리":["Miri","ミリ","美里"],"라스알카이마":["Ras Al Khaimah","ラアス・アル・ハイマ","哈伊马角"],"푸자이라":["Fujairah","フジャイラ","富查伊拉"],"아인":["Al Ain","アル・アイン","艾因"],"아지만":["Ajman","アジュマーン","阿治曼"],"움알쿠와인":["Umm Al Quwain","ウンム・アル・カイワイン","乌姆盖万"],"하타":["Hatta","ハッタ","哈塔"],"리와오아시스":["Liwa Oasis","リワ・オアシス","利瓦绿洲"],"기로카스트라":["Gjirokastër","ジロカストラ","吉诺卡斯特"],"바릴로체":["Bariloche","バリローチェ","巴里洛切"],"딜리잔":["Dilijan","ディリジャン","迪利然"],"가르니":["Garni","ガルニ","加尔尼"],"규므리":["Gyumri","ギュムリ","久姆里"],"간자":["Ganja","ギャンジャ","占贾"],"셰키":["Sheki","シェキ","舍基"],"가발라":["Gabala","ガバラ","加贝拉"],"루뱅":["Leuven","ルーヴェン","鲁汶"],"디낭":["Dinant","ディナン","迪南"],"메헬렌":["Mechelen","メッヘレン","梅赫伦"],"포토시":["Potosí","ポトシ","波托西"],"코파카바나":["Copacabana","コパカバーナ","科帕卡瓦纳"],"포스두이구아수":["Foz do Iguaçu","フォス・ド・イグアス","伊瓜苏"],"플로리아노폴리스":["Florianópolis","フロリアノーポリス","弗洛里亚诺波利斯"],"헤시피":["Recife","レシフェ","累西腓"],"바르나":["Varna","ヴァルナ","瓦尔纳"],"네세바르":["Nessebar","ネセバル","内塞巴尔"],"바탐방":["Battambang","バッタンバン","马德望"],"캄폿":["Kampot","カンポット","贡布"],"케프":["Kep","ケップ","白马"],"푸에르토바라스":["Puerto Varas","プエルト・バラス","巴拉斯港"],"푼타아레나스":["Punta Arenas","プンタ・アレーナス","蓬塔阿雷纳斯"],"칼리":["Cali","カリ","卡利"],"산타마르타":["Santa Marta","サンタ・マルタ","圣玛尔塔"],"타마린도":["Tamarindo","タマリンド","塔马林多"],"마누엘안토니오":["Manuel Antonio","マヌエル・アントニオ","曼努埃尔安东尼奥"],"시엔푸에고스":["Cienfuegos","シエンフエーゴス","西恩富戈斯"],"올보르":["Aalborg","オールボー","奥尔堡"],"스카겐":["Skagen","スケーエン","斯卡恩"],"쿠엔카":["Cuenca","クエンカ","昆卡"],"기자":["Giza","ギザ","吉萨"],"포르보":["Porvoo","ポルヴォー","波尔沃"],"사본린나":["Savonlinna","サヴォンリンナ","萨翁林纳"],"바투미":["Batumi","バトゥミ","巴统"],"쿠타이시":["Kutaisi","クタイシ","库塔伊西"],"센텐드레":["Szentendre","セントエンドレ","圣安德烈"],"데브레첸":["Debrecen","デブレツェン","德布勒森"],"쇼프론":["Sopron","ショプロン","肖普朗"],"티하니":["Tihany","ティハニ","蒂豪尼"],"세게드":["Szeged","セゲド","塞格德"],"비크":["Vík","ヴィーク","维克"],"후사비크":["Húsavík","フーサヴィーク","胡萨维克"],"야즈드":["Yazd","ヤズド","亚兹德"],"딩글":["Dingle","ディングル","丁格尔"],"킬케니":["Kilkenny","キルケニー","基尔肯尼"],"코노마라":["Connemara","コネマラ","康尼马拉"],"하이파":["Haifa","ハイファ","海法"],"나사렛":["Nazareth","ナザレ","拿撒勒"],"제라시":["Jerash","ジェラシュ","杰拉什"],"마다바":["Madaba","マダバ","马达巴"],"아스타나":["Astana","アスタナ","阿斯塔纳"],"시므켄트":["Shymkent","シムケント","奇姆肯特"],"투르키스탄":["Turkistan","トルキスタン","突厥斯坦"],"악타우":["Aktau","アクタウ","阿克套"],"나쿠루":["Nakuru","ナクル","纳库鲁"],"팍세":["Pakse","パークセー","巴色"],"시돈":["Sidon","シドン","西顿"],"클라이페다":["Klaipeda","クライペダ","克莱佩达"],"카라코룸":["Karakorum","カラコルム","哈拉和林"],"홉스골":["Khövsgöl","フブスグル","库苏古尔"],"스베티스테판":["Sveti Stefan","スヴェティ・ステファン","圣斯特凡"],"두르미토르":["Durmitor","ドゥルミトル","杜米托尔"],"라바트":["Rabat","ラバト","拉巴特"],"탕헤르":["Tangier","タンジール","丹吉尔"],"네피도":["Naypyidaw","ネピドー","内比都"],"박타푸르":["Bhaktapur","バクタプル","巴克塔普尔"],"나가르콧":["Nagarkot","ナガルコット","纳加阔特"],"네이피어":["Napier","ネイピア","内皮尔"],"더니든":["Dunedin","ダニーデン","但尼丁"],"테카포":["Lake Tekapo","テカポ湖","特卡波湖"],"스타방에르":["Stavanger","スタヴァンゲル","斯塔万格"],"트론헤임":["Trondheim","トロンハイム","特隆赫姆"],"살랄라":["Salalah","サラーラ","塞拉莱"],"수르":["Sur","スール","苏尔"],"푸노":["Puno","プーノ","普诺"],"이키토스":["Iquitos","イキトス","伊基托斯"],"보홀":["Bohol","ボホール","保和"],"엘니도":["El Nido","エルニド","爱妮岛"],"다바오":["Davao","ダバオ","达沃"],"포즈난":["Poznań","ポズナン","波兹南"],"토룬":["Toruń","トルン","托伦"],"루블린":["Lublin","ルブリン","卢布林"],"시기쇼아라":["Sighișoara","シギショアラ","锡吉什瓦拉"],"클루지나포카":["Cluj-Napoca","クルージュ・ナポカ","克卢日-纳波卡"],"콘스탄차":["Constanța","コンスタンツァ","康斯坦察"],"카잔":["Kazan","カザン","喀山"],"예카테린부르크":["Yekaterinburg","エカテリンブルク","叶卡捷琳堡"],"무르만스크":["Murmansk","ムルマンスク","摩尔曼斯克"],"메디나":["Medina","メディナ","麦地那"],"아브하":["Abha","アブハ","阿布哈"],"니시":["Niš","ニシュ","尼什"],"즐라티보르":["Zlatibor","ズラティボル","兹拉蒂博尔"],"센토사":["Sentosa","セントーサ","圣淘沙"],"마리나베이":["Marina Bay","マリーナベイ","滨海湾"],"차이나타운":["Chinatown","チャイナタウン","牛车水"],"오차드로드":["Orchard Road","オーチャード・ロード","乌节路"],"주롱":["Jurong","ジュロン","裕廊"],"바르데요프":["Bardejov","バルデヨフ","巴尔代约夫"],"질리나":["Žilina","ジリナ","日利纳"],"포스토이나":["Postojna","ポストイナ","波斯托伊纳"],"스텔렌보스":["Stellenbosch","ステレンボッシュ","斯泰伦博斯"],"포트엘리자베스":["Port Elizabeth","ポート・エリザベス","伊丽莎白港"],"허마누스":["Hermanus","ハーマナス","赫曼努斯"],"엘라":["Ella","エッラ","埃拉"],"아누라다푸라":["Anuradhapura","アヌラーダプラ","阿努拉德普勒"],"웁살라":["Uppsala","ウプサラ","乌普萨拉"],"키루나":["Kiruna","キルナ","基律纳"],"비스뷔":["Visby","ヴィスビュー","维斯比"],"아루샤":["Arusha","アルーシャ","阿鲁沙"],"수스":["Sousse","スース","苏塞"],"하마메트":["Hammamet","ハマメット","哈马马特"],"카미야네츠포딜스키":["Kamianets-Podilskyi","カミャネツィ・ポジーリシク","卡缅涅茨-波多利斯基"],"누쿠스":["Nukus","ヌクス","努库斯"],"테르메즈":["Termez","テルメズ","铁尔梅兹"],

// 한국
"서울":["Seoul","ソウル","首尔"],"부산":["Busan","釜山","釜山"],"제주":["Jeju Island","済州島","济州岛"],"경주":["Gyeongju","慶州","庆州"],"인천":["Incheon","仁川","仁川"],"대구":["Daegu","大邱","大邱"],"전주":["Jeonju","全州","全州"],"강릉":["Gangneung","江陵","江陵"],"수원":["Suwon","水原","水原"],"광주":["Gwangju","光州","光州"],"여수":["Yeosu","麗水","丽水"],"속초":["Sokcho","束草","束草"],"통영":["Tongyeong","統営","统营"],
// 일본
...
// 중국
"베이징":["Beijing","北京","北京"],"상하이":["Shanghai","上海","上海"],"시안":["Xi'an","西安","西安"],"구이린":["Guilin","桂林","桂林"],"청두":["Chengdu","成都","成都"],"항저우":["Hangzhou","杭州","杭州"],"장자제":["Zhangjiajie","張家界","张家界"],"리장":["Lijiang","麗江","丽江"],"황산":["Huangshan","黄山","黄山"],"홍콩":["Hong Kong","香港","香港"],"마카오":["Macau","マカオ","澳门","Macao"],"쑤저우":["Suzhou","蘇州","苏州"],
// 프랑스
...
// 영국
"런던":["London","ロンドン","伦敦"],"런던(캐나다)":["London","ロンドン","伦敦"],"에든버러":["Edinburgh","エディンバラ","爱丁堡"],"맨체스터":["Manchester","マンチェスター","曼彻斯特"],"바스":["Bath","バース","巴斯"],"옥스퍼드":["Oxford","オックスフォード","牛津"],"케임브리지":["Cambridge","ケンブリッジ","剑桥"],"요크":["York","ヨーク","约克"],"리버풀":["Liverpool","リバプール","利物浦"],"코츠월즈":["Cotswolds","コッツウォルズ","科茨沃尔德"],"글래스고":["Glasgow","グラスゴー","格拉斯哥"],
// 미국
"뉴욕":["New York","ニューヨーク","纽约"],"로스앤젤레스":["Los Angeles","ロサンゼルス","洛杉矶"],"샌프란시스코":["San Francisco","サンフランシスコ","旧金山"],"라스베이거스":["Las Vegas","ラスベガス","拉斯维加斯"],"마이애미":["Miami","マイアミ","迈阿密"],"시카고":["Chicago","シカゴ","芝加哥"],"워싱턴DC":["Washington D.C.","ワシントンD.C.","华盛顿"],"보스턴":["Boston","ボストン","波士顿"],"뉴올리언스":["New Orleans","ニューオーリンズ","新奥尔良"],"시애틀":["Seattle","シアトル","西雅图"],"하와이":["Hawaii","ハワイ","夏威夷"],"그랜드캐니언":["Grand Canyon","グランドキャニオン","大峡谷"],"옐로스톤":["Yellowstone","イエローストーン","黄石","West Yellowstone","웨스트옐로스톤"],"샌디에이고":["San Diego","サンディエゴ","圣迭戈"],"덴버":["Denver","デンバー","丹佛"],"내슈빌":["Nashville","ナッシュビル","纳什维尔"],"포틀랜드":["Portland","ポートランド","波特兰"],"피닉스":["Phoenix","フェニックス","凤凰城"],"올랜도":["Orlando","オーランド","奥兰多"],"나이아가라폭포":["Niagara Falls","ナイアガラの滝","尼亚加拉大瀑布"],
// 호주
"시드니":["Sydney","シドニー","悉尼"],"멜버른":["Melbourne","メルボルン","墨尔本"],"케언즈":["Cairns","ケアンズ","凯恩斯"],"울루루":["Uluru","ウルル","乌卢鲁","Yulara","율라라"],"브리즈번":["Brisbane","ブリスベン","布里斯班"],"퍼스":["Perth","パース","珀斯"],"골드코스트":["Gold Coast","ゴールドコースト","黄金海岸"],"그레이트배리어리프":["Great Barrier Reef","グレートバリアリーフ","大堡礁"],"태즈메이니아":["Tasmania","タスマニア","塔斯马尼亚"],
// 태국
...
// 터키
"이스탄불":["Istanbul","イスタンブール","伊斯坦布尔"],"카파도키아":["Cappadocia","カッパドキア","卡帕多奇亚"],"파묵칼레":["Pamukkale","パムッカレ","棉花堡"],"안탈리아":["Antalya","アンタルヤ","安塔利亚"],"에페소":["Ephesus","エフェソス","以弗所","Selcuk","Selçuk","셀추크","Efes"],"보드룸":["Bodrum","ボドルム","博德鲁姆"],"트라브존":["Trabzon","トラブゾン","特拉布宗"],
// 그리스
"산토리니":["Santorini","サントリーニ","圣托里尼"],"아테네":["Athens","アテネ","雅典"],"미코노스":["Mykonos","ミコノス","米科诺斯"],"크레타":["Crete","クレタ","克里特"],"로도스":["Rhodes","ロドス","罗德岛"],"코르푸":["Corfu","コルフ","科孚"],"메테오라":["Meteora","メテオラ","迈泰奥拉","Kalambaka","Kalabaka","Kalampaka","칼람바카"],
// 이집트
...
// 인도네시아
"발리":["Bali","バリ","巴厘岛"],"자카르타":["Jakarta","ジャカルタ","雅加达"],"족자카르타":["Yogyakarta","ジョグジャカルタ","日惹"],"코모도":["Komodo","コモド","科莫多"],"롬복":["Lombok","ロンボク","龙目岛"],"보로부두르":["Borobudur","ボロブドゥール","婆罗浮屠","Magelang","마겔랑"],"라자암팟":["Raja Ampat","ラジャ・アンパット","拉贾安帕特"],
// 말레이시아
...
// 아프리카
"케이프타운":["Cape Town","ケープタウン","开普敦"],"요하네스버그":["Johannesburg","ヨハネスブルグ","约翰内斯堡"],"더반":["Durban","ダーバン","德班"],"크루거국립공원":["Kruger National Park","クルーガー国立公園","克鲁格国家公园","Kruger","Skukuza","Nelspruit","넬스프루이트"],"드라켄즈버그":["Drakensberg","ドラケンスバーグ","德拉肯斯堡"],"나이로비":["Nairobi","ナイロビ","内罗毕"],"마사이마라":["Masai Mara","マサイマラ","马赛马拉"],"몸바사":["Mombasa","モンバサ","蒙巴萨"],"암보셀리":["Amboseli","アンボセリ","安博塞利"],"라무":["Lamu","ラム","拉穆"],"잔지바르":["Zanzibar","ザンジバル","桑给巴尔"],"세렝게티":["Serengeti","セレンゲティ","塞伦盖蒂","Seronera","Arusha","아루샤"],"킬리만자로":["Kilimanjaro","キリマンジャロ","乞力马扎罗"],"응고롱고로":["Ngorongoro","ンゴロンゴロ","恩戈罗恩戈罗"],
// 중동
"페트라":["Petra","ペトラ","佩特拉","Wadi Musa","와디무사"],"암만":["Amman","アンマン","安曼"],"와디럼":["Wadi Rum","ワディ・ラム","瓦迪拉姆"],"아카바":["Aqaba","アカバ","亚喀巴"],"예루살렘":["Jerusalem","エルサレム","耶路撒冷"],"텔아비브":["Tel Aviv","テルアビブ","特拉维夫"],"마사다":["Masada","マサダ","马萨达"],"사해":["Dead Sea","死海","死海"],
// 캐나다
"밴쿠버":["Vancouver","バンクーバー","温哥华"],"토론토":["Toronto","トロント","多伦多"],"퀘벡시티":["Quebec City","ケベックシティ","魁北克城"],"밴프":["Banff","バンフ","班夫"],"몬트리올":["Montreal","モントリオール","蒙特利尔"],"오타와":["Ottawa","オタワ","渥太华"],"나이아가라폴스":["Niagara Falls","ナイアガラの滝","尼亚加拉瀑布"],"빅토리아":["Victoria","ビクトリア","维多利亚"],"빅토리아(세이셸)":["Victoria","ビクトリア","维多利亚"],
// 쿠바·아르헨·브라질
...
// 멕시코·콜롬비아·페루·칠레
"멕시코시티":["Mexico City","メキシコシティ","墨西哥城"],"칸쿤":["Cancún","カンクン","坎昆"],"과달라하라":["Guadalajara","グアダラハラ","瓜达拉哈拉"],"오악사카":["Oaxaca","オアハカ","瓦哈卡"],"툴룸":["Tulum","トゥルム","图卢姆"],"과나후아토":["Guanajuato","グアナフアト","瓜纳华托"],"치첸이트사":["Chichén Itzá","チチェン・イッツァ","奇琴伊察","Chichen Itza","Tinum","Tinúm","Valladolid","바야돌리드"],"보고타":["Bogotá","ボゴタ","波哥大"],"카르타헤나":["Cartagena","カルタヘナ","卡塔赫纳"],"카르타헤나(스페인)":["Cartagena","カルタヘナ","卡塔赫纳"],"메데인":["Medellín","メデジン","麦德林"],"살렌토":["Salento","サレント","萨伦托"],"마추픽추":["Machu Picchu","マチュ・ピチュ","马丘比丘","Machupicchu","Aguas Calientes","아구아스칼리엔테스"],"쿠스코":["Cusco","クスコ","库斯科"],"리마":["Lima","リマ","利马"],"나스카":["Nazca","ナスカ","纳斯卡"],"티티카카호수":["Lake Titicaca","チチカカ湖","的的喀喀湖"],"아레키파":["Arequipa","アレキパ","阿雷基帕"],"산티아고":["Santiago","サンティアゴ","圣地亚哥"],"발파라이소":["Valparaíso","バルパライソ","瓦尔帕莱索"],"아타카마":["Atacama","アタカマ","阿塔卡马"],"토레스델파이네":["Torres del Paine","トレス・デル・パイネ","百内"],"이스터섬":["Easter Island","イースター島","复活节岛"],
// 뉴질랜드
...
"코르도바":["Córdoba","コルドバ","科尔多瓦"],"코르도바(아르헨티나)":["Córdoba","コルドバ","科尔多瓦"],"사라고사":["Zaragoza","サラゴサ","萨拉戈萨"],"쿠엥카":["Cuenca","クエンカ","昆卡"],"론다":["Ronda","ロンダ","龙达"],"카디스":["Cádiz","カディス","加的斯"],"살라망카":["Salamanca","サラマンカ","萨拉曼卡"],"세고비아":["Segovia","セゴビア","塞哥维亚"],"팔마":["Palma","パルマ","帕尔马"],"이비자":["Ibiza","イビサ","伊维萨"],"테네리페":["Tenerife","テネリフェ","特内里费"],
