...
// 해외 영토·속령·자치 지역 수도
"누크":["Nuuk","ヌーク","努克"],"산후안":["San Juan","サンフアン","圣胡安"],"누메아":["Nouméa","ヌメア","努美阿"],"파페에테":["Papeete","パペーテ","帕皮提"],"아바루아":["Avarua","アバルア","阿瓦鲁阿"],"오라녜스타트":["Oranjestad","オラニエスタッド","奥拉涅斯塔德"],"빌렘스타트":["Willemstad","ウィレムスタット","威廉斯塔德"],"해밀턴":["Hamilton","ハミルトン","汉密尔顿"],"토르스하운":["Tórshavn","トースハウン","托尔斯港"],"하르게이사":["Hargeisa","ハルゲイサ","哈尔格萨"],"엘아이운":["Laayoune","アイウン","阿尤恩"],"알로피":["Alofi","アロフィ","阿洛菲"],"더밸리":["The Valley","バレー","河谷镇"],"스탠리":["Stanley","スタンリー","斯坦利"],"콕번타운":["Cockburn Town","コックバーンタウン","科伯恩城"],"로드타운":["Road Town","ロードタウン","罗德城"],"샬럿아말리에":["Charlotte Amalie","シャーロット・アマリー","夏洛特阿马利亚"],"하갓냐":["Hagåtña","ハガニア","阿加尼亚"],"사이판":["Saipan","サイパン","塞班岛"],"파고파고":["Pago Pago","パゴパゴ","帕果帕果"],"세인트헬리어":["Saint Helier","セントヘリア","圣赫利尔"],"세인트피터포트":["Saint Peter Port","セントピーターポート","圣彼得港"],"더글러스":["Douglas","ダグラス","道格拉斯"],"플리머스":["Plymouth","プリマス","普利茅斯"],"북니코시아":["North Nicosia","北ニコシア","北尼科西亚"],"필립스뷔르흐":["Philipsburg","フィリップスブルフ","菲利普斯堡"],"마리고":["Marigot","マリゴ","马里戈"],"귀스타비아":["Gustavia","グスタビア","古斯塔维亚"],"제임스타운":["Jamestown","ジェームズタウン","詹姆斯敦"],
}
