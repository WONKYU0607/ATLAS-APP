...
"카불":["Kabul","カブール","喀布尔"],"알제":["Algiers","アルジェ","阿尔及尔"],"루안다":["Luanda","ルアンダ","罗安达"],"예레반":["Yerevan","エレバン","埃里温"],"바쿠":["Baku","バクー","巴库"],"마나마":["Manama","マナーマ","麦纳麦"],"다카":["Dhaka","ダッカ","达卡"],"민스크":["Minsk","ミンスク","明斯克"],"벨리즈시티":["Belize City","ベリーズシティ","伯利兹城"],"코토누":["Cotonou","コトヌー","科托努"],"팀부":["Thimphu","ティンプー","廷布"],"사라예보":["Sarajevo","サラエボ","萨拉热窝"],"가보로네":["Gaborone","ハボローネ","哈博罗内"],"반다르스리브가완":["Bandar Seri Begawan","バンダルスリブガワン","斯里巴加湾"],"와가두구":["Ouagadougou","ワガドゥグー","瓦加杜古"],"기테가":["Gitega","ギテガ","基特加"],"프라이아":["Praia","プライア","普拉亚"],"야운데":["Yaoundé","ヤウンデ","雅温得"],"방기":["Bangui","バンギ","班吉"],"은자메나":["N'Djamena","ンジャメナ","恩贾梅纳"],"모로니":["Moroni","モロニ","莫罗尼"],"킨샤사":["Kinshasa","キンシャサ","金沙萨"],"지부티시":["Djibouti City","ジブチ","吉布提"],"산살바도르":["San Salvador","サンサルバドル","圣萨尔瓦多"],"말라보":["Malabo","マラボ","马拉博"],"아스마라":["Asmara","アスマラ","阿斯马拉"],"음바바네":["Mbabane","ムババネ","姆巴巴内"],"리브르빌":["Libreville","リーブルヴィル","利伯维尔"],"반줄":["Banjul","バンジュール","班珠尔"],"코나크리":["Conakry","コナクリ","科纳克里"],"비사우":["Bissau","ビサウ","比绍"],"조지타운":["Georgetown","ジョージタウン","乔治敦"],"포르토프랭스":["Port-au-Prince","ポルトープランス","太子港"],"테구시갈파":["Tegucigalpa","テグシガルパ","特古西加尔巴"],"바그다드":["Baghdad","バグダッド","巴格达"],"아비장":["Abidjan","アビジャン","阿比让"],"프리슈티나":["Pristina","プリシュティナ","普里什蒂纳"],"쿠웨이트시티":["Kuwait City","クウェート","科威特城"],"비슈케크":["Bishkek","ビシュケク","比什凯克"],"마세루":["Maseru","マセル","马塞卢"],"몬로비아":["Monrovia","モンロビア","蒙罗维亚"],"트리폴리":["Tripoli","トリポリ","的黎波里"],"릴롱궤":["Lilongwe","リロングウェ","利隆圭"],"바마코":["Bamako","バマコ","巴马科"],"누악쇼트":["Nouakchott","ヌアクショット","努瓦克肖特"],"키시나우":["Chișinău","キシナウ","基希讷乌"],"마푸토":["Maputo","マプト","马普托"],"마나과":["Managua","マナグア","马那瓜"],"니아메":["Niamey","ニアメ","尼亚美"],"라고스":["Lagos","ラゴス","拉各斯"],"아부자":["Abuja","アブジャ","阿布贾"],"평양":["Pyongyang","平壌","平壤"],"스코페":["Skopje","スコピエ","斯科普里"],"포트모르즈비":["Port Moresby","ポートモレスビー","莫尔兹比港"],"아순시온":["Asunción","アスンシオン","亚松森"],"브라자빌":["Brazzaville","ブラザヴィル","布拉柴维尔"],"프리타운":["Freetown","フリータウン","弗里敦"],"모가디슈":["Mogadishu","モガディシュ","摩加迪沙"],"주바":["Juba","ジュバ","朱巴"],"하르툼":["Khartoum","ハルツーム","喀土穆"],"파라마리보":["Paramaribo","パラマリボ","帕拉马里博"],"다마스쿠스":["Damascus","ダマスカス","大马士革"],"두샨베":["Dushanbe","ドゥシャンベ","杜尚别"],"딜리":["Dili","ディリ","帝力"],"로메":["Lomé","ロメ","洛美"],"포트오브스페인":["Port of Spain","ポートオブスペイン","西班牙港"],"아시가바트":["Ashgabat","アシガバート","阿什哈巴德"],"캄팔라":["Kampala","カンパラ","坎帕拉"],"몬테비데오":["Montevideo","モンテビデオ","蒙得维的亚"],"카라카스":["Caracas","カラカス","加拉加斯"],"사나":["Sana'a","サナア","萨那"],"루사카":["Lusaka","ルサカ","卢萨卡"],
  ...
  "아오모리": ["Aomori", "青森", "青森"],
  "미야자키": ["Miyazaki", "宮崎", "宫崎"],
  "마츠야마": ["Matsuyama", "松山", "松山"],
  "시코쿠": ["Shikoku", "四国", "四国"],
  "교토시": ["Kyoto City", "京都市", "京都市"],
  "나가노": ["Nagano", "長野", "长野"],
  "다카마쓰": ["Takamatsu", "高松", "高松"],
  "가고시마": ["Kagoshima", "鹿児島", "鹿儿岛"],
  "아키타": ["Akita", "秋田", "秋田"],
  "선전": ["Shenzhen", "深圳", "深圳"],
  "광저우": ["Guangzhou", "広州", "广州"],
  "충칭": ["Chongqing", "重慶", "重庆"],
  ...
  "릴": ["Lille", "リール", "里尔"],
  "디종": ["Dijon", "ディジョン", "第戎"],
  "아비뇽": ["Avignon", "アヴィニョン", "阿维尼翁"],
  "렌": ["Rennes", "レンヌ", "雷恩"],
  "콜마르": ["Colmar", "コルマール", "科尔马"],
  "카르카손": ["Carcassonne", "カルカソンヌ", "卡尔卡松"],
  "샤모니": ["Chamonix", "シャモニー", "夏蒙尼"],
  "생말로": ["Saint-Malo", "サン・マロ", "圣马洛"],
  "엑상프로방스": ["Aix-en-Provence", "エクス・アン・プロヴァンス", "艾克斯"],
  "몽펠리에": ["Montpellier", "モンペリエ", "蒙彼利埃"],
  "토리노": ["Turin", "トリノ", "都灵"],
  "제노바": ["Genoa", "ジェノヴァ", "热那亚"],
  "팔레르모": ["Palermo", "パレルモ", "巴勒莫"],
  "바리": ["Bari", "バーリ", "巴里"],
  "베로나": ["Verona", "ヴェローナ", "维罗纳"],
  "피사": ["Pisa", "ピサ", "比萨"],
  "페루자": ["Perugia", "ペルージャ", "佩鲁贾"],
  "루카": ["Lucca", "ルッカ", "卢卡"],
  "마테라": ["Matera", "マテーラ", "马泰拉"],
  "트리에스테": ["Trieste", "トリエステ", "的里雅斯特"],
  "사라고사": ["Zaragoza", "サラゴサ", "萨拉戈萨"],
  "코르도바": ["Cordoba", "コルドバ", "科尔多瓦"],
  "세고비아": ["Segovia", "セゴビア", "塞哥维亚"],
  "팔마데마요르카": ["Palma de Mallorca", "パルマ・デ・マヨルカ", "帕尔马"],
  "론다": ["Ronda", "ロンダ", "龙达"],
  "살라만카": ["Salamanca", "サラマンカ", "萨拉曼卡"],
  "히혼": ["Gijón", "ヒホン", "希洪"],
  "이비자": ["Ibiza", "イビサ", "伊维萨"],
  "알리칸테": ["Alicante", "アリカンテ", "阿利坎特"],
  "부르고스": ["Burgos", "ブルゴス", "布尔戈斯"],
  "슈투트가르트": ["Stuttgart", "シュトゥットガルト", "斯图加特"],
  "뉘른베르크": ["Nuremberg", "ニュルンベルク", "纽伦堡"],
  "뒤셀도르프": ["Düsseldorf", "デュッセルドルフ", "杜塞尔多夫"],
  "라이프치히": ["Leipzig", "ライプツィヒ", "莱比锡"],
  "하노버": ["Hanover", "ハノーファー", "汉诺威"],
  "브레멘": ["Bremen", "ブレーメン", "不来梅"],
  "포츠담": ["Potsdam", "ポツダム", "波茨坦"],
  "본": ["Bonn", "ボン", "波恩"],
  "바덴바덴": ["Baden-Baden", "バーデン・バーデン", "巴登巴登"],
  "도르트문트": ["Dortmund", "ドルトムント", "多特蒙德"],
  "에센": ["Essen", "エッセン", "埃森"],
  "프라이부르크": ["Freiburg", "フライブルク", "弗莱堡"],
  "로스토크": ["Rostock", "ロストック", "罗斯托克"],
  "브라이턴": ["Brighton", "ブライトン", "布莱顿"],
  "브리스톨": ["Bristol", "ブリストル", "布里斯托"],
  "카디프": ["Cardiff", "カーディフ", "加的夫"],
  "벨파스트": ["Belfast", "ベルファスト", "贝尔法斯特"],
  "셰필드": ["Sheffield", "シェフィールド", "谢菲尔德"],
  "리즈": ["Leeds", "リーズ", "利兹"],
  "스트랫퍼드어폰에이번": ["Stratford-upon-Avon", "ストラトフォード・アポン・エイヴォン", "埃文河畔斯特拉福德"],
  "윈저": ["Windsor", "ウィンザー", "温莎"],
  "인버네스": ["Inverness", "インヴァネス", "因弗内斯"],
  "노팅엄": ["Nottingham", "ノッティンガム", "诺丁汉"],
  "버밍엄": ["Birmingham", "バーミンガム", "伯明翰"],
  "캔터베리": ["Canterbury", "カンタベリー", "坎特伯雷"],
  "뉴캐슬": ["Newcastle", "ニューカッスル", "纽卡斯尔"],
  "애들레이드": ["Adelaide", "アデレード", "阿德莱德"],
  "캔버라": ["Canberra", "キャンベラ", "堪培拉"],
  "다윈": ["Darwin", "ダーウィン", "达尔文"],
  "호바트": ["Hobart", "ホバート", "霍巴特"],
  "바이런베이": ["Byron Bay", "バイロンベイ", "拜伦湾"],
  "앨리스스프링스": ["Alice Springs", "アリススプリングス", "爱丽丝泉"],
  "블루마운틴": ["Blue Mountains", "ブルーマウンテンズ", "蓝山"],
  "선샤인코스트": ["Sunshine Coast", "サンシャインコースト", "阳光海岸"],
  "프레이저섬": ["Fraser Island", "フレーザー島", "弗雷泽岛"],
  "필립아일랜드": ["Phillip Island", "フィリップ島", "菲利普岛"],
  "태즈매니아": ["Tasmania", "タスマニア", "塔斯马尼亚"],
  "브룸": ["Broome", "ブルーム", "布鲁姆"],
  "코팡안": ["Ko Pha-ngan", "パンガン島", "帕岸岛"],
  "수코타이": ["Sukhothai", "スコータイ", "素可泰"],
  "카오락": ["Khao Lak", "カオラック", "考拉"],
  "후아힌": ["Hua Hin", "ホアヒン", "华欣"],
  "코창": ["Ko Chang", "チャーン島", "象岛"],
  "매홍손": ["Mae Hong Son", "メーホンソン", "夜丰颂"],
  "파이": ["Pai", "パーイ", "拜县"],
  "남차뭄": ["Nakhon Pathom", "ナコンパトム", "佛统"],
  "나콘랏차시마": ["Nakhon Ratchasima", "ナコンラチャシマ", "呵叻"],
  "칸차나부리": ["Kanchanaburi", "カンチャナブリー", "北碧"],
  "끄라비": ["Krabi", "クラビ", "甲米"],
  "나콘라차시마": ["Nakhon Ratchasima", "ナコンラチャシマ", "呵叻"],
  "깐짜나부리": ["Kanchanaburi", "カンチャナブリー", "北碧"],
  "핫야이": ["Hat Yai", "ハジャイ", "合艾"],
  "수랏타니": ["Surat Thani", "スラタニ", "素叻他尼"],
  "우본랏차타니": ["Ubon Ratchathani", "ウボンラチャタニ", "乌汶"],
  "람빵": ["Lampang", "ランパーン", "南邦"],
  "첸나이": ["Chennai", "チェンナイ", "金奈"],
  "방갈로르": ["Bangalore", "バンガロール", "班加罗尔"],
  "하이데라바드": ["Hyderabad", "ハイデラバード", "海得拉巴"],
  "조드푸르": ["Jodhpur", "ジョードプル", "焦特布尔"],
  "다르질링": ["Darjeeling", "ダージリン", "大吉岭"],
  "리시케시": ["Rishikesh", "リシケーシュ", "瑞诗凯诗"],
  "코친": ["Kochi", "コーチ", "科钦"],
  "코치": ["Kochi", "コーチ", "科钦"],
  "마이소르": ["Mysore", "マイソール", "迈索尔"],
  "푸네": ["Pune", "プネー", "浦那"],
  "시킴": ["Sikkim", "シッキム", "锡金"],
  "럭나우": ["Lucknow", "ラクナウ", "勒克瑙"],
  "앙카라": ["Ankara", "アンカラ", "安卡拉"],
  "이즈미르": ["Izmir", "イズミル", "伊兹密尔"],
  "부르사": ["Bursa", "ブルサ", "布尔萨"],
  "페티예": ["Fethiye", "フェティエ", "费特希耶"],
  "마르딘": ["Mardin", "マルディン", "马尔丁"],
  "가지안테프": ["Gaziantep", "ガズィアンテプ", "加济安泰普"],
  "가지안텝": ["Gaziantep", "ガズィアンテプ", "加济安泰普"],
  "사프란볼루": ["Safranbolu", "サフランボル", "萨夫兰博卢"],
  "콘야": ["Konya", "コンヤ", "科尼亚"],
  "시바스": ["Sivas", "シワス", "锡瓦斯"],
  "아다나": ["Adana", "アダナ", "阿达纳"],
  "디야르바크르": ["Diyarbakır", "ディヤルバクル", "迪亚巴克尔"],
  "샨르우르파": ["Şanlıurfa", "シャンルウルファ", "尚勒乌尔法"],
  "에페소스": ["Ephesus", "エフェソス", "以弗所"],
  "반": ["Van", "ヴァン", "凡城"],
  "안카라": ["Antalya", "アンタルヤ", "安塔利亚"],
  "테살로니키": ["Thessaloniki", "テッサロニキ", "塞萨洛尼基"],
  "델피": ["Delphi", "デルフィ", "德尔斐"],
  "파트라": ["Patras", "パトラ", "帕特雷"],
  "나프플리오": ["Nafplio", "ナフプリオ", "纳夫普利翁"],
  "나플리오": ["Nafplio", "ナフプリオ", "纳夫普利翁"],
  "자킨토스": ["Zakynthos", "ザキントス", "扎金索斯"],
  "케팔로니아": ["Kefalonia", "ケファロニア", "凯法利尼亚"],
  "요안니나": ["Ioannina", "ヨアニナ", "约阿尼纳"],
  "이오아니나": ["Ioannina", "ヨアニナ", "约阿尼纳"],
  "낙소스": ["Naxos", "ナクソス", "纳克索斯"],
  "히오스": ["Chios", "ヒオス", "希俄斯"],
  "미스트라스": ["Mystras", "ミストラス", "米斯特拉斯"],
  "올림피아": ["Olympia", "オリンピア", "奥林匹亚"],
  "할키디키": ["Halkidiki", "ハルキディキ", "哈尔基季基"],
  "파로스": ["Paros", "パロス", "帕罗斯"],
  "이라클리온": ["Heraklion", "イラクリオン", "伊拉克利翁"],
  "칼람바카": ["Kalambaka", "カランバカ", "卡兰巴卡"],
  "하니아": ["Chania", "ハニア", "哈尼亚"],
  "카바라": ["Kavala", "カヴァラ", "卡瓦拉"],
  "볼로스": ["Volos", "ヴォロス", "沃洛斯"],
  "코스": ["Kos", "コス", "科斯"],
  "스파르타": ["Sparta", "スパルタ", "斯巴达"],
  "달랏": ["Da Lat", "ダラット", "大叻"],
  "하이퐁": ["Haiphong", "ハイフォン", "海防"],
  "칸토": ["Can Tho", "カントー", "芹苴"],
  "퀴논": ["Quy Nhon", "クイニョン", "归仁"],
  "빈증": ["Binh Duong", "ビンズオン", "平阳"],
  "붕따우": ["Vung Tau", "ブンタウ", "头顿"],
  "꽝빈": ["Quang Binh", "クアンビン", "广平"],
  "떠이닌": ["Tay Ninh", "タイニン", "西宁"],
  "하띤": ["Ha Tinh", "ハティン", "河静"],
  "쯔엉미": ["Truong My", "チュオンミー", "长美"],
  "수라바야": ["Surabaya", "スラバヤ", "泗水"],
  "반둥": ["Bandung", "バンドン", "万隆"],
  "메단": ["Medan", "メダン", "棉兰"],
  "우붓": ["Ubud", "ウブド", "乌布"],
  "기리트라왕안": ["Gili Trawangan", "ギリ・トラワンガン", "吉利群岛"],
  "세마랑": ["Semarang", "スマラン", "三宝垄"],
  "마카사르": ["Makassar", "マカッサル", "望加锡"],
  "토바호수": ["Lake Toba", "トバ湖", "多巴湖"],
  "플로레스": ["Flores", "フローレス", "弗洛勒斯"],
  "부킷라왕": ["Bukittinggi", "ブキティンギ", "武吉丁宜"],
  "마날도": ["Manado", "マナド", "万鸦老"],
  "만도": ["Manado", "マナド", "万鸦老"],
  "솔로": ["Solo", "ソロ", "梭罗"],
  "빈탄": ["Bintan", "ビンタン", "民丹"],
  "라부안바조": ["Labuan Bajo", "ラブアンバジョ", "纳闽巴霍"],
  "부킷팅기": ["Bukittinggi", "ブキティンギ", "武吉丁宜"],
  "토라자": ["Toraja", "トラジャ", "托拉查"],
  "팔렘방": ["Palembang", "パレンバン", "巨港"],
  "말랑": ["Malang", "マラン", "玛琅"],
  "에보라": ["Évora", "エヴォラ", "埃武拉"],
  "브라가": ["Braga", "ブラガ", "布拉加"],
  "파로": ["Faro", "ファロ", "法鲁"],
  "기마랑이스": ["Guimarães", "ギマランイス", "吉马良斯"],
  "아베이루": ["Aveiro", "アヴェイロ", "阿威罗"],
  "비제우": ["Viseu", "ヴィゼウ", "维塞乌"],
  "오비두스": ["Óbidos", "オビドス", "奥比都斯"],
  "나자레": ["Nazaré", "ナザレ", "纳扎雷"],
  "세투발": ["Setúbal", "セトゥーバル", "塞图巴尔"],
  "토마르": ["Tomar", "トマール", "托马尔"],
  "몬산투": ["Monsanto", "モンサント", "蒙桑图"],
  "비아나두카스텔루": ["Viana do Castelo", "ヴィアナ・ド・カステロ", "维亚纳堡"],
  "레이리아": ["Leiria", "レイリア", "莱里亚"],
  "델프트": ["Delft", "デルフト", "代尔夫特"],
  "하를렘": ["Haarlem", "ハールレム", "哈勒姆"],
  "레이든": ["Leiden", "ライデン", "莱顿"],
  "흐로닝언": ["Groningen", "フローニンゲン", "格罗宁根"],
  "에인트호번": ["Eindhoven", "アイントホーフェン", "埃因霍温"],
  "브레다": ["Breda", "ブレダ", "布雷达"],
  "틸뷔르흐": ["Tilburg", "ティルブルフ", "蒂尔堡"],
  "잔세스한스": ["Zaanse Schans", "ザーンセ・スカンス", "桑斯安斯"],
  "잔세스칸스": ["Zaanse Schans", "ザーンセ・スカンス", "桑斯安斯"],
  "히트호른": ["Giethoorn", "ヒートホールン", "羊角村"],
  "아른헴": ["Arnhem", "アーネム", "阿纳姆"],
  "도르드레흐트": ["Dordrecht", "ドルドレヒト", "多德雷赫特"],
  "미들뷔르흐": ["Middelburg", "ミデルブルフ", "米德尔堡"],
  "알크마르": ["Alkmaar", "アルクマール", "阿尔克马尔"],
  "아메르스포르트": ["Amersfoort", "アメルスフォールト", "阿默斯福特"],
  "캄펜": ["Kampen", "カンペン", "坎彭"],
  "킨더다이크": ["Kinderdijk", "キンデルダイク", "小孩堤防"],
  "바젤": ["Basel", "バーゼル", "巴塞尔"],
  "로잔": ["Lausanne", "ローザンヌ", "洛桑"],
  "생모리츠": ["St. Moritz", "サンモリッツ", "圣莫里茨"],
  "몽트뢰": ["Montreux", "モントルー", "蒙特勒"],
  "다보스": ["Davos", "ダヴォス", "达沃斯"],
  "루가노": ["Lugano", "ルガーノ", "卢加诺"],
  "그린델발트": ["Grindelwald", "グリンデルワルト", "格林德瓦"],
  "튠": ["Thun", "トゥーン", "图恩"],
  "툰": ["Thun", "トゥーン", "图恩"],
  "샤프하우젠": ["Schaffhausen", "シャフハウゼン", "沙夫豪森"],
  "뇌샤텔": ["Neuchâtel", "ヌーシャテル", "纳沙泰尔"],
  "아펜첼": ["Appenzell", "アッペンツェル", "阿彭策尔"],
  "빈터투어": ["Winterthur", "ヴィンタートゥール", "温特图尔"],
  "시옹": ["Sion", "シオン", "锡永"],
  "프리부르": ["Fribourg", "フリブール", "弗里堡"],
  "브리엔츠": ["Brienz", "ブリエンツ", "布里恩茨"],
  "솔로투른": ["Solothurn", "ゾロトゥルン", "索洛图恩"],
  "캘거리": ["Calgary", "カルガリー", "卡尔加里"],
  "에드먼턴": ["Edmonton", "エドモントン", "埃德蒙顿"],
  "위니펙": ["Winnipeg", "ウィニペグ", "温尼伯"],
  "핼리팩스": ["Halifax", "ハリファックス", "哈利法克斯"],
  "위슬러": ["Whistler", "ウィスラー", "惠斯勒"],
  "샬럿타운": ["Charlottetown", "シャーロットタウン", "夏洛特敦"],
  "옐로나이프": ["Yellowknife", "イエローナイフ", "黄刀镇"],
  "화이트호스": ["Whitehorse", "ホワイトホース", "白马市"],
  "재스퍼": ["Jasper", "ジャスパー", "贾斯珀"],
  "레이크루이스": ["Lake Louise", "レイクルイーズ", "路易斯湖"],
  "해밀턴": ["Hamilton", "ハミルトン", "汉密尔顿"],
  "사스카툰": ["Saskatoon", "サスカトゥーン", "萨斯卡通"],
  "세인트존스": ["St. John's", "セントジョンズ", "圣约翰斯"],
  "레지나": ["Regina", "レジャイナ", "里贾纳"],
  "처칠": ["Churchill", "チャーチル", "丘吉尔"],
  "헤시피": ["Recife", "レシフェ", "累西腓"],
  "레시페": ["Recife", "レシフェ", "累西腓"],
  "쿠리치바": ["Curitiba", "クリチバ", "库里蒂巴"],
  "벨로리존치": ["Belo Horizonte", "ベロオリゾンテ", "贝洛奥里藏特"],
  "벨로오리존치": ["Belo Horizonte", "ベロオリゾンテ", "贝洛奥里藏特"],
  "플로리아노폴리스": ["Florianópolis", "フロリアノーポリス", "弗洛里亚诺波利斯"],
  "벨렝": ["Belém", "ベレン", "贝伦"],
  "나타우": ["Natal", "ナタル", "纳塔尔"],
  "나탈": ["Natal", "ナタル", "纳塔尔"],
  "마세이오": ["Maceió", "マセイオ", "马塞约"],
  "그라마두": ["Gramado", "グラマド", "格拉玛多"],
  "파라치": ["Paraty", "パラチー", "帕拉蒂"],
  "페르난두지노로냐": ["Fernando de Noronha", "フェルナンド・デ・ノローニャ", "费尔南多迪诺罗尼亚"],
  "포르투알레그리": ["Porto Alegre", "ポルトアレグレ", "阿雷格里港"],
  "캄피나스": ["Campinas", "カンピーナス", "坎皮纳斯"],
  "오우루프레투": ["Ouro Preto", "オウロプレト", "欧鲁普雷图"],
  "올린다": ["Olinda", "オリンダ", "奥林达"],
  "푸에블라": ["Puebla", "プエブラ", "普埃布拉"],
  "메리다": ["Mérida", "メリダ", "梅里达"],
  "몬테레이": ["Monterrey", "モンテレイ", "蒙特雷"],
  "산미겔데아옌데": ["San Miguel de Allende", "サンミゲルデアジェンデ", "圣米格尔德阿连德"],
  "카보산루카스": ["Cabo San Lucas", "カボサンルーカス", "卡波圣卢卡斯"],
  "플라야델카르멘": ["Playa del Carmen", "プラヤデルカルメン", "卡门海滩"],
  "발라돌리드": ["Valladolid", "バジャドリド", "巴利亚多利德"],
  "파츠쿠아로": ["Pátzcuaro", "パツクアロ", "帕茨夸罗"],
  "타스코": ["Taxco", "タスコ", "塔斯科"],
  "이슬라무헤레스": ["Isla Mujeres", "イスラムヘーレス", "女人岛"],
  "아카풀코": ["Acapulco", "アカプルコ", "阿卡普尔科"],
  "케레타로": ["Querétaro", "ケレタロ", "克雷塔罗"],
  "사카테카스": ["Zacatecas", "サカテカス", "萨卡特卡斯"],
  "오아하카": ["Oaxaca", "オアハカ", "瓦哈卡"],
  "푸에르토바야르타": ["Puerto Vallarta", "プエルトバヤルタ", "巴亚尔塔港"],
  "산크리스토발": ["San Cristóbal de las Casas", "サンクリストバル", "圣克里斯托瓦尔"],
  "모렐리아": ["Morelia", "モレリア", "莫雷利亚"],
  "티후아나": ["Tijuana", "ティフアナ", "蒂华纳"],
  "치와와": ["Chihuahua", "チワワ", "奇瓦瓦"],
  "케언스": ["Cairns", "ケアンズ", "凯恩斯"],
  "벨렘": ["Belém", "ベレン", "贝伦"],
  "갈웨이": ["Galway", "ゴールウェイ", "戈尔韦"],
  "안도라라벨랴": ["Andorra la Vella", "アンドラ・ラ・ベリャ", "安道尔城"],
  "나소": ["Nassau", "ナッソー", "拿骚"],
  "브리지타운": ["Bridgetown", "ブリッジタウン", "布里奇敦"],
  "로조": ["Roseau", "ロゾー", "罗索"],
  "세인트조지스": ["St. George's", "セントジョージズ", "圣乔治"],
  "타라와": ["Tarawa", "タラワ", "塔拉瓦"],
  "파두츠": ["Vaduz", "ファドゥーツ", "瓦杜兹"],
  "발레타": ["Valletta", "ヴァレッタ", "瓦莱塔"],
  "마주로": ["Majuro", "マジュロ", "马朱罗"],
  "팔리키르": ["Palikir", "パリキール", "帕利基尔"],
  "모나코": ["Monaco", "モナコ", "摩纳哥"],
  "야렌": ["Yaren", "ヤレン", "亚伦"],
  "응에룰무드": ["Ngerulmud", "ンゲルルムド", "恩吉鲁穆德"],
  "라말라": ["Ramallah", "ラマッラー", "拉姆安拉"],
  "바스테르": ["Basseterre", "バセテール", "巴斯特尔"],
  "캐스트리스": ["Castries", "カストリーズ", "卡斯特里"],
  "킹스타운": ["Kingstown", "キングスタウン", "金斯敦"],
  "아피아": ["Apia", "アピア", "阿皮亚"],
  "산마리노": ["San Marino", "サンマリノ", "圣马力诺"],
  "상투메": ["São Tomé", "サントメ", "圣多美"],
  "호니아라": ["Honiara", "ホニアラ", "霍尼亚拉"],
  "누쿠알로파": ["Nukuʻalofa", "ヌクアロファ", "努库阿洛法"],
  "푸나푸티": ["Funafuti", "フナフティ", "富纳富提"],
  "포트빌라": ["Port Vila", "ポートビラ", "维拉港"],
  "바티칸시티": ["Vatican City", "バチカン市国", "梵蒂冈"],
}
